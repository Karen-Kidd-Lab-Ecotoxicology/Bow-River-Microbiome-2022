...
#Exposed (Graves Bridge) vs non wastewater exposed sites (Cochrane + Sunalta + Cushing Bridge)

deseq_exposed_trichop_rare <- phyloseq_to_deseq2(trichop_ps_rare, ~ Exposure)
#Re level the reference variable so that the comparison is exposed vs unexposed
deseq_exposed_trichop_rare$Exposure <-relevel(deseq_exposed_trichop_rare$Exposure, "Unexposed")

deseq_exposed_trichop_rare <- DESeq(deseq_exposed_trichop_rare, test = "Wald", fitType = "parametric", sfType = "poscounts")

res_deseq_exposed_trichop_rare <- results(deseq_exposed_trichop_rare, cooksCutoff = FALSE)
alpha = 0.001
sigtab_exposed_trichop_rare = res_deseq_exposed_trichop_rare[which(res_deseq_exposed_trichop_rare$padj < alpha), ]
sigtab_exposed_trichop_rare = cbind(as(sigtab_exposed_trichop_rare, "data.frame"), as(tax_table(trichop_ps_rare)[rownames(sigtab_exposed_trichop_rare), ], "matrix"))

x_exposed_trichop_rare = tapply(sigtab_exposed_trichop_rare$log2FoldChange, sigtab_exposed_trichop_rare$Phylum, function(x) max(x))
x_exposed_trichop_rare = sort(x_exposed_trichop_rare, TRUE)
sigtab_exposed_trichop_rare$Phylum = factor(as.character(sigtab_exposed_trichop_rare$Phylum), levels=names(x_exposed_trichop_rare))
#1 differentially abundant bacteria

# Genus
x_exposed_trichop_rare = tapply(sigtab_exposed_trichop_rare$log2FoldChange, sigtab_exposed_trichop_rare$Genus, function(x) max(x))
x_exposed_trichop_rare = sort(x_exposed_trichop_rare, TRUE)
sigtab_exposed_trichop_rare$Genus = factor(as.character(sigtab_exposed_trichop_rare$Genus), levels=sort(names(x_exposed_trichop_rare)))


diff_abund_trichop_plot_rare<-ggplot(sigtab_exposed_trichop_rare, aes(y=Genus, x=log2FoldChange, color=Phylum))+
  geom_point(aes(fill=Phylum), pch=21, size=6, color="black") +
  theme_bw()+
...
diff_abund_trichop_plot_rare

#ggsave(filename="microbiome_analysis/Final analysis/Differential Abundance Results/Exposed vs Unexposed sites Trichoptera adults Bow rarefied.png", height=18, width=18)
...
deseq_exposed_hep_rare <- phyloseq_to_deseq2(hep_ps_rare, ~ Exposure)
#Re level the reference variable so that the comparison is exposed vs unexposed
deseq_exposed_hep_rare$Exposure <-relevel(deseq_exposed_hep_rare$Exposure, "Unexposed")

deseq_exposed_hep_rare <- DESeq(deseq_exposed_hep_rare, test = "Wald", fitType = "parametric", sfType = "poscounts")

res_deseq_exposed_hep_rare <- results(deseq_exposed_hep_rare, cooksCutoff = FALSE)
alpha = 0.001
sigtab_exposed_hep_rare = res_deseq_exposed_hep_rare[which(res_deseq_exposed_hep_rare$padj < alpha), ]
sigtab_exposed_hep_rare = cbind(as(sigtab_exposed_hep_rare, "data.frame"), as(tax_table(hep_ps_rare)[rownames(sigtab_exposed_hep_rare), ], "matrix"))

x_exposed_hep_rare = tapply(sigtab_exposed_hep_rare$log2FoldChange, sigtab_exposed_hep_rare$Phylum, function(x) max(x))
x_exposed_hep_rare = sort(x_exposed_hep_rare, TRUE)
sigtab_exposed_hep_rare$Phylum = factor(as.character(sigtab_exposed_hep_rare$Phylum), levels=names(x_exposed_hep_rare))
# Genus
x_exposed_hep_rare = tapply(sigtab_exposed_hep_rare$log2FoldChange, sigtab_exposed_hep_rare$Genus, function(x) max(x))
x_exposed_hep_rare = sort(x_exposed_hep_rare, TRUE)
sigtab_exposed_hep_rare$Genus = factor(as.character(sigtab_exposed_hep_rare$Genus), levels=sort(names(x_exposed_hep_rare)))
#17 differentially abundant taxa

diff_abund_hep_plot_rare<-ggplot(sigtab_exposed_hep_rare, aes(y=Genus, x=log2FoldChange, color=Phylum))+
  geom_point(aes(fill=Phylum), pch=21, size=6, color="black") +
  theme_bw()+
 ...
 labs(y = expression(Log[2]~ "Ratio of Absolute Abundance"))+
  scale_color_brewer(palette="Set3")
diff_abund_hep_plot_rare

#ggsave(filename="microbiome_analysis/Final analysis/Differential Abundance Results/Exposed vs Unexposed sites larval heptageniidae rarefied.png", height=15, width=22)
...
deseq_exposed_chiro_rare <- phyloseq_to_deseq2(chiro_ps_rare, ~ Exposure)
#Re level the reference variable so that the comparison is exposed vs unexposed
deseq_exposed_chiro_rare$Exposure <-relevel(deseq_exposed_chiro_rare$Exposure, "Unexposed")

deseq_exposed_chiro_rare <- DESeq(deseq_exposed_chiro_rare, test = "Wald", fitType = "parametric", sfType = "poscounts")

res_deseq_exposed_chiro_rare <- results(deseq_exposed_chiro_rare, cooksCutoff = FALSE)
alpha = 0.001
sigtab_exposed_chiro_rare = res_deseq_exposed_chiro_rare[which(res_deseq_exposed_chiro_rare$padj < alpha), ]
sigtab_exposed_chiro_rare = cbind(as(sigtab_exposed_chiro_rare, "data.frame"), as(tax_table(chiro_ps_rare)[rownames(sigtab_exposed_chiro_rare), ], "matrix"))
#2 differentially abundant bacteria

x_exposed_chiro_rare = tapply(sigtab_exposed_chiro_rare$log2FoldChange, sigtab_exposed_chiro_rare$Phylum, function(x) max(x))
x_exposed_chiro_rare = sort(x_exposed_chiro_rare, TRUE)
sigtab_exposed_chiro_rare$Phylum = factor(as.character(sigtab_exposed_chiro_rare$Phylum), levels=names(x_exposed_chiro_rare))
# Genus
x_exposed_chiro_rare = tapply(sigtab_exposed_chiro_rare$log2FoldChange, sigtab_exposed_chiro_rare$Genus, function(x) max(x))
x_exposed_chiro_rare = sort(x_exposed_chiro_rare, TRUE)
sigtab_exposed_chiro_rare$Genus = factor(as.character(sigtab_exposed_chiro_rare$Genus), levels=sort(names(x_exposed_chiro_rare)))

ggplot(sigtab_exposed_chiro_rare, aes(y=Genus, x=log2FoldChange, color=Phylum))+
  geom_point(size=6) + 
  theme_bw()+
  theme(axis.text.y = element_text(size=24, face="italic", color="black")) + theme(axis.text.x=element_text(size=24, color="black"), axis.title=element_text(size=28)) +
          theme(legend.text=element_text(size=24, color="black")) + 
...
deseq_exposed_dip_rare <- phyloseq_to_deseq2(dip_ps_rare, ~ Exposure)
#Re level the reference variable so that the comparison is exposed vs unexposed
deseq_exposed_dip_rare$Exposure <-relevel(deseq_exposed_dip_rare$Exposure, "Unexposed")

deseq_exposed_dip_rare <- DESeq(deseq_exposed_dip_rare, test = "Wald", fitType = "parametric", sfType = "poscounts")

res_deseq_exposed_dip_rare <- results(deseq_exposed_dip_rare, cooksCutoff = FALSE)
alpha = 0.001
sigtab_exposed_dip_rare = res_deseq_exposed_dip_rare[which(res_deseq_exposed_dip_rare$padj < alpha), ]
sigtab_exposed_dip_rare = cbind(as(sigtab_exposed_dip_rare, "data.frame"), as(tax_table(dip_ps_rare)[rownames(sigtab_exposed_dip_rare), ], "matrix"))
#8 differnetially abundant bacteria

#Phylum
x_exposed_dip_rare = tapply(sigtab_exposed_dip_rare$log2FoldChange, sigtab_exposed_dip_rare$Phylum, function(x) max(x))
x_exposed_dip_rare = sort(x_exposed_dip_rare, TRUE)
sigtab_exposed_dip_rare$Phylum = factor(as.character(sigtab_exposed_dip_rare$Phylum), levels=names(x_exposed_dip_rare))
# Genus
x_exposed_dip_rare = tapply(sigtab_exposed_dip_rare$log2FoldChange, sigtab_exposed_dip_rare$Genus, function(x) max(x))
x_exposed_dip_rare = sort(x_exposed_dip_rare, TRUE)
sigtab_exposed_dip_rare$Genus = factor(as.character(sigtab_exposed_dip_rare$Genus), levels=sort(names(x_exposed_dip_rare)))

ggplot(sigtab_exposed_dip_rare, aes(y=Genus, x=log2FoldChange, color=Phylum))+
  geom_point(size=6) + 
  theme_bw()+
  theme(axis.text.y = element_text(size=24, face="italic", color="black")) + theme(axis.text.x=element_text(size=24, color="black"), axis.title=element_text(size=28)) +
          theme(legend.text=element_text(size=24, color="black")) + 
...
deseq_exposed_perl_rare <- phyloseq_to_deseq2(perl_ps_rare, ~ Exposure)
#Re level the reference variable so that the comparison is exposed vs unexposed
deseq_exposed_perl_rare$Exposure <-relevel(deseq_exposed_perl_rare$Exposure, "Unexposed")

deseq_exposed_perl_rare <- DESeq(deseq_exposed_perl_rare, test = "Wald", fitType = "parametric", sfType = "poscounts")

res_deseq_exposed_perl_rare <- results(deseq_exposed_perl_rare, cooksCutoff = FALSE)
alpha = 0.001
sigtab_exposed_perl_rare = res_deseq_exposed_perl_rare[which(res_deseq_exposed_perl_rare$padj < alpha), ]
sigtab_exposed_perl_rare = cbind(as(sigtab_exposed_perl_rare, "data.frame"), as(tax_table(perl_ps_rare)[rownames(sigtab_exposed_perl_rare), ], "matrix"))
#1 differentially abundant bacteria

#Phylum
x_exposed_perl_rare = tapply(sigtab_exposed_perl_rare$log2FoldChange, sigtab_exposed_perl_rare$Phylum, function(x) max(x))
x_exposed_perl_rare = sort(x_exposed_perl_rare, TRUE)
sigtab_exposed_perl_rare$Phylum = factor(as.character(sigtab_exposed_perl_rare$Phylum), levels=names(x_exposed_perl_rare))
# Genus
x_exposed_perl_rare = tapply(sigtab_exposed_perl_rare$log2FoldChange, sigtab_exposed_perl_rare$Genus, function(x) max(x))
x_exposed_perl_rare = sort(x_exposed_perl_rare, TRUE)
sigtab_exposed_perl_rare$Genus = factor(as.character(sigtab_exposed_perl_rare$Genus), levels=sort(names(x_exposed_perl_rare)))

ggplot(sigtab_exposed_perl_rare, aes(y=Genus, x=log2FoldChange, color=Phylum))+
  geom_point(size=6) + 
  theme_bw()+
  theme(axis.text.y = element_text(size=24, face="italic", color="black")) + theme(axis.text.x=element_text(size=24, color="black"), axis.title=element_text(size=28)) +
          theme(legend.text=element_text(size=24, color="black")) + 
...
deseq_exposed_aran_rare <- phyloseq_to_deseq2(aran_ps_rare, ~ Exposure)
#Re level the reference variable so that the comparison is exposed vs unexposed
deseq_exposed_aran_rare$Exposure <-relevel(deseq_exposed_aran_rare$Exposure, "Unexposed")

deseq_exposed_aran_rare <- DESeq(deseq_exposed_aran_rare, test = "Wald", fitType = "parametric", sfType = "poscounts")

res_deseq_exposed_aran_rare <- results(deseq_exposed_aran_rare, cooksCutoff = FALSE)
alpha = 0.001
sigtab_exposed_aran_rare = res_deseq_exposed_aran_rare[which(res_deseq_exposed_aran_rare$padj < alpha), ]
sigtab_exposed_aran_rare = cbind(as(sigtab_exposed_aran_rare, "data.frame"), as(tax_table(aran_ps_rare)[rownames(sigtab_exposed_aran_rare), ], "matrix"))
#0 differentially abundant bacteria
...
deseq_exposed_tetra_rare <- phyloseq_to_deseq2(tetra_ps_rare, ~ Exposure)
#Re level the reference variable so that the comparison is exposed vs unexposed
deseq_exposed_tetra_rare$Exposure <-relevel(deseq_exposed_tetra_rare$Exposure, "Unexposed")

deseq_exposed_tetra_rare <- DESeq(deseq_exposed_tetra_rare, test = "Wald", fitType = "parametric", sfType = "poscounts")

res_deseq_exposed_tetra_rare <- results(deseq_exposed_tetra_rare, cooksCutoff = FALSE)
alpha = 0.001
sigtab_exposed_tetra_rare = res_deseq_exposed_tetra_rare[which(res_deseq_exposed_tetra_rare$padj < alpha), ]
sigtab_exposed_tetra_rare = cbind(as(sigtab_exposed_tetra_rare, "data.frame"), as(tax_table(tetra_ps_rare)[rownames(sigtab_exposed_tetra_rare), ], "matrix"))
#2 DA bacteria

#Phylum
x_exposed_tetra_rare = tapply(sigtab_exposed_tetra_rare$log2FoldChange, sigtab_exposed_tetra_rare$Phylum, function(x) max(x))
x_exposed_tetra_rare = sort(x_exposed_tetra_rare, TRUE)
sigtab_exposed_tetra_rare$Phylum = factor(as.character(sigtab_exposed_tetra_rare$Phylum), levels=names(x_exposed_tetra_rare))
# Genus
x_exposed_tetra_rare = tapply(sigtab_exposed_tetra_rare$log2FoldChange, sigtab_exposed_tetra_rare$Genus, function(x) max(x))
x_exposed_tetra_rare = sort(x_exposed_tetra_rare, TRUE)
sigtab_exposed_tetra_rare$Genus = factor(as.character(sigtab_exposed_tetra_rare$Genus), levels=sort(names(x_exposed_tetra_rare)))


ggplot(sigtab_exposed_tetra_rare, aes(y=Genus, x=log2FoldChange, color=Phylum))+
  geom_point(size=6) + 
  theme_bw()+
  theme(axis.text.y = element_text(size=24, face="italic", color="black")) + theme(axis.text.x=element_text(size=24, color="black"), axis.title=element_text(size=28)) +
          theme(legend.text=element_text(size=24, color="black")) + 
