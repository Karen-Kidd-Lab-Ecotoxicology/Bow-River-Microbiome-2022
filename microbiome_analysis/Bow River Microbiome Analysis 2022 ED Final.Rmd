...
endo<-subset_taxa(sample_ps, Genus=="Buchnera" | Genus=="Candidatus Cardinium" | Genus=="Rickettsia" | Genus =="Wolbachia" | Genus=="Spiroplasma" | Genus=="Candidatus Hamiltonella" | Genus=="Candidatus Megaira")
endo<-prune_taxa(taxa_sums(endo) > 0, endo) 
endo #48 taxa 
