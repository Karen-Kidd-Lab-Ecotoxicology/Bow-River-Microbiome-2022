...
#ggsave(filename="microbiome_analysis/Final analysis/Differential Abundance Results/Bow River exposed vs unexposed sites caddisfly adults only.png", height=15, width=22)
...
#ggsave(filename="microbiome_analysis/Final analysis/Differential Abundance Results/Bow River exposed vs unexposed sites adult mayfly only.png", height=15, width=22)
...
diff_abund_hydro_plot_1<- diff_abund_hydro_plot + rremove("axis.title")
diff_abund_hep_plot_1<- diff_abund_hep_plot + rremove("axis.title")
diff_abund_chiro_plot_1<- diff_abund_chiro_plot + rremove("axis.title")
diff_abund_perl_plot_1<- diff_abund_perl_plot + rremove("axis.title")
diff_abund_trichop_plot_1<- diff_abund_trichop_plot + rremove("axis.title")
diff_abund_ephem_plot_1<- diff_abund_ephem_plot + rremove("axis.title")
diff_abund_dip_plot_1<- diff_abund_dip_plot + rremove("axis.title")
diff_abund_tetra_plot_1<- diff_abund_tetra_plot + rremove("axis.title")

ggarrange(diff_abund_hydro_plot_1, diff_abund_hep_plot_1, diff_abund_chiro_plot_1, diff_abund_perl_plot_1, diff_abund_trichop_plot_1, diff_abund_ephem_plot_1, diff_abund_dip_plot_1, diff_abund_tetra_plot_1, nrow=3, ncol=3)

#ggsave(filename="microbiome_analysis/Final analysis/Differential Abundance Results/diff abund across taxa Bow River.png", height=10, width=10)
