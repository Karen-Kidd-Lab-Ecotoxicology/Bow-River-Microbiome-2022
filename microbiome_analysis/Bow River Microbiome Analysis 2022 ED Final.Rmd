...
hydro_rel_abun_plot_ACWA <- ggplot(hydro_ACWA_phylum, aes(y=taxon, x=rel_abund, color=Site)) +
  stat_summary(fun.data=median_hilow, geom = "pointrange",
               ...
               position = position_dodge(width=1)) +
  coord_trans(x="log10") +
  #facet_nested_wrap(~Stage+sample_Family, nrow=1, scale="free_x")+
  scale_x_continuous(limits=c(NA, 100),
                     breaks=c(0.01, 0.1, 1, 10, 100),
                     labels=c(0.01, 0.1, 1, 10, 100)) +
...
## DESeq2 all sites compared to reference - Cochrane/REF - inverts separated
```{r}
#### Hydropsychidae Bow ####
...
#ggsave("microbiome_analysis/Final analysis/Differential Abundance Results/diff_abund_hydro_exposed.png", height=18, width=18, bg="white")

# Heptageniidae #
diff_abund_hep_plot_1<- diff_abund_hep_plot + rremove("axis.title")+ rremove("legend")
diff_abund_hep_plot_1
#ggsave("microbiome_analysis/Final analysis/Differential Abundance Results/diff_abund_hep_exposed.png", height=18, width=18, bg="white")
...
#ggsave("microbiome_analysis/Final analysis/Differential Abundance Results/diff_abund_perl_exposed.png", height=10, width=10, bg="white")
...
#ggsave("microbiome_analysis/Final analysis/Differential Abundance Results/diff_abund_dip_exposed.png", height=22, width=18, bg="white")
