...
effluent_Bow_genus<-tax_glom(effluent_Bow, taxrank="Genus")
effluent_Bow_genus #107
...
effluent_ACWA_genus<-tax_glom(effluent_ACWA, taxrank="Genus")
effluent_ACWA_genus<-prune_taxa(taxa_sums(effluent_ACWA) >0, effluent_ACWA)
effluent_ACWA_genus 
...
nsamples(cochrane<-subset_samples(sample_ps, Site=="Cochrane")) #65

coch_genus = tax_glom(cochrane, "Genus") %>% 
  transform_sample_counts(function(x) {x * 100/sum(x)}) 
coch_genus<-prune_taxa(taxa_sums(coch_genus) > 0, coch_genus)

coch_genus_df <- psmelt(coch_genus) %>%  
  as_tibble %>%
    group_by(Genus) %>%
  dplyr::select(c("Abundance", "Genus")) %>%
  dplyr::summarise(Mean = mean(Abundance), SD = sd(Abundance))

coch_eff<- coch_genus_df %>%
...
coch_eff$SD_squared ='^'(coch_eff$SD,2)
coch_eff$SD_squared_divided =(coch_eff$SD_squared/65) 
  
top_means_eff_coch<-aggregate(Mean ~ Genus, data = coch_eff, FUN = sum)
top_SD_eff_coch<-aggregate(SD_squared_divided ~ Genus, data = coch_eff, FUN = sum)

top_eff_coch<-merge(top_means_eff_coch, top_SD_eff_coch, by=c("Genus"))
top_eff_coch$SD_Final<-sqrt(top_eff_coch$SD_squared_divided)
View(top_eff_coch)
...
nsamples(sunalta<-subset_samples(sample_ps, Site=="Sunalta")) #46

sun_genus = tax_glom(sunalta, "Genus") %>% 
  transform_sample_counts(function(x) {x * 100/sum(x)}) 
sun_genus<-prune_taxa(taxa_sums(sun_genus) > 0, sun_genus)

sun_genus_df <- psmelt(sun_genus) %>%  
  as_tibble %>%
    group_by(Genus) %>%
  dplyr::select(c("Abundance", "Genus")) %>%
  dplyr::summarise(Mean = mean(Abundance), SD = sd(Abundance))

sun_eff<- sun_genus_df %>%
  mutate(Genus = fct_other(Genus, keep=c("AAP99","Achromobacter", "Acidovorax" ,"Acinetobacter","Aeromonas" ,"Alcaligenes" ,"Amaricoccus" ,"Anaerovorax","Arcticibacter","Aridibacter","Arthrobacter" ,"Asticcacaulis","Azoarcus" ,"Azospira","Bacillus" ,"Bacteroides","Bauldia" ,"Bdellovibrio","Blastocatella" ,"Blastomonas","Blautia" ,"Blvii28 wastewater-sludge group","Bordetella","Brachybacterium","Bryobacter","Candidatus Accumulibacter" , "Candidatus Amoebophilus" ,"Candidatus Anammoximicrobium","Candidatus Competibacter" ,"Candidatus Microthrix" ,"Candidatus Nitrotoga" ,"Cetobacterium" ,"Chryseobacterium" ,"Citrobacter" ,"Cloacibacterium" ,"Clostridium sensu stricto 1" ,"Clostridium sensu stricto 2" ,"Clostridium sensu stricto 3","Clostridium sensu stricto 5" ,"Clostridium sensu stricto 8","Clostridium sensu stricto 9","Clostridium sensu stricto 10","Clostridium sensu stricto 13","Clostridium sensu stricto 14" ,"Comamonas" ,"Corynebacterium" ,"Cytophaga" ,"Dechloromonas" ,"Defluviicoccus" ,"Desulfatiglans" ,"Desulfovibrio" ,"Devosia","Ensifer","Enterococcus" ,"Escherichia-Shigella" ,"Faecalibacterium" ,"Faecalitalea" ,"Ferruginibacter" ,"Flexibacter","Fluviicola","Gemmata","Gordonia","Haliscomenobacter" ,"Helicobacter" ,"Hydrogenophaga" ,"Hyphomicrobium" ,"Hyphomonas","Ignavibacterium","Isosphaera" ,"Klebsiella","Lachnospira" ,"Lachnobacillus" ,"Legionella" ,"Methylocystis" ,"Methylotenera","Micrococcus" ,"Moraxella" ,"Mycobacterium" ,"Neisseria" ,"Nitrobacter","Nitrosomonas" ,"Nitrospira" ,"Nocardioides" ,"Novosphingobium" ,"Ottawia" ,"Paludibacter" ,"Pantoea","Parabacteroides","Paracoccus" ,"Pseudomonas" ,"Pseudorhodobacter" ,"Ralstonia" ,"Rhodobacter" ,"Rhodococcus","Romboutsia" ,"Roseburia","Ruminococcus" ,"Runella" ,"Serratia" ,"Shinella" ,"Smithella","Staphylococcus" ,"Stenotrophobacter" ,"Stenotrophomonas","Streptococcus","Sulfuritalea" ,"Syntrophobacter" ,"Syntrophomonas","Syntrophus","Terrimonas" ,"Thermomonas" ,"Trichococcus" ,"Xanthomonas","Zoogloea")))%>%
  ungroup()
View(sun_eff)

sun_eff$SD_squared ='^'(sun_eff$SD,2)
sun_eff$SD_squared_divided =(sun_eff$SD_squared/46) 
  
top_means_eff_sun<-aggregate(Mean ~ Genus, data = sun_eff, FUN = sum)
top_SD_eff_sun<-aggregate(SD_squared_divided ~ Genus, data = sun_eff, FUN = sum)

top_eff_sun<-merge(top_means_eff_sun, top_SD_eff_sun, by=c("Genus"))
top_eff_sun$SD_Final<-sqrt(top_eff_sun$SD_squared_divided)
View(top_eff_sun)
...
nsamples(cushbr<-subset_samples(sample_ps, Site=="Cushing Bridge")) #61

cushbr_genus = tax_glom(cushbr, "Genus") %>% 
  transform_sample_counts(function(x) {x * 100/sum(x)}) 
cushbr_genus<-prune_taxa(taxa_sums(cushbr_genus) > 0, cushbr_genus)

cushbr_genus_df <- psmelt(cushbr_genus) %>%  
  as_tibble %>%
    group_by(Genus) %>%
  dplyr::select(c("Abundance", "Genus")) %>%
  dplyr::summarise(Mean = mean(Abundance), SD = sd(Abundance))

cushbr_eff<- cushbr_genus_df %>%
  mutate(Genus = fct_other(Genus, keep=c("AAP99","Achromobacter", "Acidovorax" ,"Acinetobacter","Aeromonas" ,"Alcaligenes" ,"Amaricoccus" ,"Anaerovorax","Arcticibacter","Aridibacter","Arthrobacter" ,"Asticcacaulis","Azoarcus" ,"Azospira","Bacillus" ,"Bacteroides","Bauldia" ,"Bdellovibrio","Blastocatella" ,"Blastomonas","Blautia" ,"Blvii28 wastewater-sludge group","Bordetella","Brachybacterium","Bryobacter","Candidatus Accumulibacter" , "Candidatus Amoebophilus" ,"Candidatus Anammoximicrobium","Candidatus Competibacter" ,"Candidatus Microthrix" ,"Candidatus Nitrotoga" ,"Cetobacterium" ,"Chryseobacterium" ,"Citrobacter" ,"Cloacibacterium" ,"Clostridium sensu stricto 1" ,"Clostridium sensu stricto 2" ,"Clostridium sensu stricto 3","Clostridium sensu stricto 5" ,"Clostridium sensu stricto 8","Clostridium sensu stricto 9","Clostridium sensu stricto 10","Clostridium sensu stricto 13","Clostridium sensu stricto 14" ,"Comamonas" ,"Corynebacterium" ,"Cytophaga" ,"Dechloromonas" ,"Defluviicoccus" ,"Desulfatiglans" ,"Desulfovibrio" ,"Devosia","Ensifer","Enterococcus" ,"Escherichia-Shigella" ,"Faecalibacterium" ,"Faecalitalea" ,"Ferruginibacter" ,"Flexibacter","Fluviicola","Gemmata","Gordonia","Haliscomenobacter" ,"Helicobacter" ,"Hydrogenophaga" ,"Hyphomicrobium" ,"Hyphomonas","Ignavibacterium","Isosphaera" ,"Klebsiella","Lachnospira" ,"Lachnobacillus" ,"Legionella" ,"Methylocystis" ,"Methylotenera","Micrococcus" ,"Moraxella" ,"Mycobacterium" ,"Neisseria" ,"Nitrobacter","Nitrosomonas" ,"Nitrospira" ,"Nocardioides" ,"Novosphingobium" ,"Ottawia" ,"Paludibacter" ,"Pantoea","Parabacteroides","Paracoccus" ,"Pseudomonas" ,"Pseudorhodobacter" ,"Ralstonia" ,"Rhodobacter" ,"Rhodococcus","Romboutsia" ,"Roseburia","Ruminococcus" ,"Runella" ,"Serratia" ,"Shinella" ,"Smithella","Staphylococcus" ,"Stenotrophobacter" ,"Stenotrophomonas","Streptococcus","Sulfuritalea" ,"Syntrophobacter" ,"Syntrophomonas","Syntrophus","Terrimonas" ,"Thermomonas" ,"Trichococcus" ,"Xanthomonas","Zoogloea")))%>%
  ungroup()
View(cushbr_eff)

cushbr_eff$SD_squared ='^'(cushbr_eff$SD,2)
cushbr_eff$SD_squared_divided =(cushbr_eff$SD_squared/61) 
  
top_means_eff_cushbr<-aggregate(Mean ~ Genus, data = cushbr_eff, FUN = sum)
top_SD_eff_cushbr<-aggregate(SD_squared_divided ~ Genus, data = cushbr_eff, FUN = sum)

top_eff_cushbr<-merge(top_means_eff_cushbr, top_SD_eff_cushbr, by=c("Genus"))
top_eff_cushbr$SD_Final<-sqrt(top_eff_cushbr$SD_squared_divided)
View(top_eff_cushbr)
...
nsamples(grvbr<-subset_samples(sample_ps, Site=="Graves Bridge")) #47

grvbr_genus = tax_glom(grvbr, "Genus") %>% 
  transform_sample_counts(function(x) {x * 100/sum(x)}) 
grvbr_genus<-prune_taxa(taxa_sums(grvbr_genus) > 0, grvbr_genus)

grvbr_genus_df <- psmelt(grvbr_genus) %>%  
  as_tibble %>%
    group_by(Genus) %>%
  dplyr::select(c("Abundance", "Genus")) %>%
  dplyr::summarise(Mean = mean(Abundance), SD = sd(Abundance))

grvbr_eff<- grvbr_genus_df %>%
  mutate(Genus = fct_other(Genus, keep=c("AAP99","Achromobacter", "Acidovorax" ,"Acinetobacter","Aeromonas" ,"Alcaligenes" ,"Amaricoccus" ,"Anaerovorax","Arcticibacter","Aridibacter","Arthrobacter" ,"Asticcacaulis","Azoarcus" ,"Azospira","Bacillus" ,"Bacteroides","Bauldia" ,"Bdellovibrio","Blastocatella" ,"Blastomonas","Blautia" ,"Blvii28 wastewater-sludge group","Bordetella","Brachybacterium","Bryobacter","Candidatus Accumulibacter" , "Candidatus Amoebophilus" ,"Candidatus Anammoximicrobium","Candidatus Competibacter" ,"Candidatus Microthrix" ,"Candidatus Nitrotoga" ,"Cetobacterium" ,"Chryseobacterium" ,"Citrobacter" ,"Cloacibacterium" ,"Clostridium sensu stricto 1" ,"Clostridium sensu stricto 2" ,"Clostridium sensu stricto 3","Clostridium sensu stricto 5" ,"Clostridium sensu stricto 8","Clostridium sensu stricto 9","Clostridium sensu stricto 10","Clostridium sensu stricto 13","Clostridium sensu stricto 14" ,"Comamonas" ,"Corynebacterium" ,"Cytophaga" ,"Dechloromonas" ,"Defluviicoccus" ,"Desulfatiglans" ,"Desulfovibrio" ,"Devosia","Ensifer","Enterococcus" ,"Escherichia-Shigella" ,"Faecalibacterium" ,"Faecalitalea" ,"Ferruginibacter" ,"Flexibacter","Fluviicola","Gemmata","Gordonia","Haliscomenobacter" ,"Helicobacter" ,"Hydrogenophaga" ,"Hyphomicrobium" ,"Hyphomonas","Ignavibacterium","Isosphaera" ,"Klebsiella","Lachnospira" ,"Lachnobacillus" ,"Legionella" ,"Methylocystis" ,"Methylotenera","Micrococcus" ,"Moraxella" ,"Mycobacterium" ,"Neisseria" ,"Nitrobacter","Nitrosomonas" ,"Nitrospira" ,"Nocardioides" ,"Novosphingobium" ,"Ottawia" ,"Paludibacter" ,"Pantoea","Parabacteroides","Paracoccus" ,"Pseudomonas" ,"Pseudorhodobacter" ,"Ralstonia" ,"Rhodobacter" ,"Rhodococcus","Romboutsia" ,"Roseburia","Ruminococcus" ,"Runella" ,"Serratia" ,"Shinella" ,"Smithella","Staphylococcus" ,"Stenotrophobacter" ,"Stenotrophomonas","Streptococcus","Sulfuritalea" ,"Syntrophobacter" ,"Syntrophomonas","Syntrophus","Terrimonas" ,"Thermomonas" ,"Trichococcus" ,"Xanthomonas","Zoogloea")))%>%
  ungroup()
View(grvbr_eff)

grvbr_eff$SD_squared ='^'(grvbr_eff$SD,2)
grvbr_eff$SD_squared_divided =(grvbr_eff$SD_squared/47) 
  
top_means_eff_grvbr<-aggregate(Mean ~ Genus, data = grvbr_eff, FUN = sum)
top_SD_eff_grvbr<-aggregate(SD_squared_divided ~ Genus, data = grvbr_eff, FUN = sum)

top_eff_grvbr<-merge(top_means_eff_grvbr, top_SD_eff_grvbr, by=c("Genus"))
top_eff_grvbr$SD_Final<-sqrt(top_eff_grvbr$SD_squared_divided)
View(top_eff_grvbr)
...
nsamples(pmf<-subset_samples(sample_ps, Site=="Policeman Flats")) #57

pmf_genus = tax_glom(pmf, "Genus") %>% 
  transform_sample_counts(function(x) {x * 100/sum(x)}) 
pmf_genus<-prune_taxa(taxa_sums(pmf_genus) > 0, pmf_genus)

pmf_genus_df <- psmelt(pmf_genus) %>%  
  as_tibble %>%
    group_by(Genus) %>%
  dplyr::select(c("Abundance", "Genus")) %>%
  dplyr::summarise(Mean = mean(Abundance), SD = sd(Abundance))

pmf_eff<- pmf_genus_df %>%
  mutate(Genus = fct_other(Genus, keep=c("AAP99","Achromobacter", "Acidovorax" ,"Acinetobacter","Aeromonas" ,"Alcaligenes" ,"Amaricoccus" ,"Anaerovorax","Arcticibacter","Aridibacter","Arthrobacter" ,"Asticcacaulis","Azoarcus" ,"Azospira","Bacillus" ,"Bacteroides","Bauldia" ,"Bdellovibrio","Blastocatella" ,"Blastomonas","Blautia" ,"Blvii28 wastewater-sludge group","Bordetella","Brachybacterium","Bryobacter","Candidatus Accumulibacter" , "Candidatus Amoebophilus" ,"Candidatus Anammoximicrobium","Candidatus Competibacter" ,"Candidatus Microthrix" ,"Candidatus Nitrotoga" ,"Cetobacterium" ,"Chryseobacterium" ,"Citrobacter" ,"Cloacibacterium" ,"Clostridium sensu stricto 1" ,"Clostridium sensu stricto 2" ,"Clostridium sensu stricto 3","Clostridium sensu stricto 5" ,"Clostridium sensu stricto 8","Clostridium sensu stricto 9","Clostridium sensu stricto 10","Clostridium sensu stricto 13","Clostridium sensu stricto 14" ,"Comamonas" ,"Corynebacterium" ,"Cytophaga" ,"Dechloromonas" ,"Defluviicoccus" ,"Desulfatiglans" ,"Desulfovibrio" ,"Devosia","Ensifer","Enterococcus" ,"Escherichia-Shigella" ,"Faecalibacterium" ,"Faecalitalea" ,"Ferruginibacter" ,"Flexibacter","Fluviicola","Gemmata","Gordonia","Haliscomenobacter" ,"Helicobacter" ,"Hydrogenophaga" ,"Hyphomicrobium" ,"Hyphomonas","Ignavibacterium","Isosphaera" ,"Klebsiella","Lachnospira" ,"Lachnobacillus" ,"Legionella" ,"Methylocystis" ,"Methylotenera","Micrococcus" ,"Moraxella" ,"Mycobacterium" ,"Neisseria" ,"Nitrobacter","Nitrosomonas" ,"Nitrospira" ,"Nocardioides" ,"Novosphingobium" ,"Ottawia" ,"Paludibacter" ,"Pantoea","Parabacteroides","Paracoccus" ,"Pseudomonas" ,"Pseudorhodobacter" ,"Ralstonia" ,"Rhodobacter" ,"Rhodococcus","Romboutsia" ,"Roseburia","Ruminococcus" ,"Runella" ,"Serratia" ,"Shinella" ,"Smithella","Staphylococcus" ,"Stenotrophobacter" ,"Stenotrophomonas","Streptococcus","Sulfuritalea" ,"Syntrophobacter" ,"Syntrophomonas","Syntrophus","Terrimonas" ,"Thermomonas" ,"Trichococcus" ,"Xanthomonas","Zoogloea")))%>%
  ungroup()
View(pmf_eff)

pmf_eff$SD_squared ='^'(pmf_eff$SD,2)
pmf_eff$SD_squared_divided =(pmf_eff$SD_squared/57) 
  
top_means_eff_pmf<-aggregate(Mean ~ Genus, data = pmf_eff, FUN = sum)
top_SD_eff_pmf<-aggregate(SD_squared_divided ~ Genus, data = pmf_eff, FUN = sum)

top_eff_pmf<-merge(top_means_eff_pmf, top_SD_eff_pmf, by=c("Genus"))
top_eff_pmf$SD_Final<-sqrt(top_eff_pmf$SD_squared_divided)
View(top_eff_pmf)
...
hydro_coch_genus = tax_glom(hydro_coch, "Genus") %>% 
  transform_sample_counts(function(x) {x * 100/sum(x)}) 
hydro_coch_genus<-prune_taxa(taxa_sums(hydro_coch_genus) > 0, hydro_coch_genus)

hydro_coch_genus_df <- psmelt(hydro_coch_genus) %>%  
  as_tibble %>%
    group_by(Genus) %>%
  dplyr::select(c("Abundance", "Genus")) %>%
  dplyr::summarise(Mean = mean(Abundance), SD = sd(Abundance))

hydro_coch_eff<- hydro_coch_genus_df %>%
  mutate(Genus = fct_other(Genus, keep=c("AAP99","Achromobacter", "Acidovorax" ,"Acinetobacter","Aeromonas" ,"Alcaligenes" ,"Amaricoccus" ,"Anaerovorax","Arcticibacter","Aridibacter","Arthrobacter" ,"Asticcacaulis","Azoarcus" ,"Azospira","Bacillus" ,"Bacteroides","Bauldia" ,"Bdellovibrio","Blastocatella" ,"Blastomonas","Blautia" ,"Blvii28 wastewater-sludge group","Bordetella","Brachybacterium","Bryobacter","Candidatus Accumulibacter" , "Candidatus Amoebophilus" ,"Candidatus Anammoximicrobium","Candidatus Competibacter" ,"Candidatus Microthrix" ,"Candidatus Nitrotoga" ,"Cetobacterium" ,"Chryseobacterium" ,"Citrobacter" ,"Cloacibacterium" ,"Clostridium sensu stricto 1" ,"Clostridium sensu stricto 2" ,"Clostridium sensu stricto 3","Clostridium sensu stricto 5" ,"Clostridium sensu stricto 8","Clostridium sensu stricto 9","Clostridium sensu stricto 10","Clostridium sensu stricto 13","Clostridium sensu stricto 14" ,"Comamonas" ,"Corynebacterium" ,"Cytophaga" ,"Dechloromonas" ,"Defluviicoccus" ,"Desulfatiglans" ,"Desulfovibrio" ,"Devosia","Ensifer","Enterococcus" ,"Escherichia-Shigella" ,"Faecalibacterium" ,"Faecalitalea" ,"Ferruginibacter" ,"Flexibacter","Fluviicola","Gemmata","Gordonia","Haliscomenobacter" ,"Helicobacter" ,"Hydrogenophaga" ,"Hyphomicrobium" ,"Hyphomonas","Ignavibacterium","Isosphaera" ,"Klebsiella","Lachnospira" ,"Lachnobacillus" ,"Legionella" ,"Methylocystis" ,"Methylotenera","Micrococcus" ,"Moraxella" ,"Mycobacterium" ,"Neisseria" ,"Nitrobacter","Nitrosomonas" ,"Nitrospira" ,"Nocardioides" ,"Novosphingobium" ,"Ottawia" ,"Paludibacter" ,"Pantoea","Parabacteroides","Paracoccus" ,"Pseudomonas" ,"Pseudorhodobacter" ,"Ralstonia" ,"Rhodobacter" ,"Rhodococcus","Romboutsia" ,"Roseburia","Ruminococcus" ,"Runella" ,"Serratia" ,"Shinella" ,"Smithella","Staphylococcus" ,"Stenotrophobacter" ,"Stenotrophomonas","Streptococcus","Sulfuritalea" ,"Syntrophobacter" ,"Syntrophomonas","Syntrophus","Terrimonas" ,"Thermomonas" ,"Trichococcus" ,"Xanthomonas","Zoogloea")))%>%
  ungroup()
View(hydro_coch_eff)

hydro_coch_eff$SD_squared ='^'(hydro_coch_eff$SD,2)
hydro_coch_eff$SD_squared_divided =(hydro_coch_eff$SD_squared/36) 
  
hydro_top_means_eff_coch<-aggregate(Mean ~ Genus, data = hydro_coch_eff, FUN = sum)
hydro_top_SD_eff_coch<-aggregate(SD_squared_divided ~ Genus, data = hydro_coch_eff, FUN = sum)

hydro_top_eff_coch<-merge(hydro_top_means_eff_coch, hydro_top_SD_eff_coch, by=c("Genus"))
hydro_top_eff_coch$SD_Final<-sqrt(hydro_top_eff_coch$SD_squared_divided)
View(hydro_top_eff_coch)
...
hydro_eff_Bow<-hydro_eff_Bow(prune_taxa(taxa_sums) > 0, hydro_eff_Bow)
hydro_eff_Bow
...
hydro_eff_coch<-subset_samples(effluent_bac, Site=="Cochrane" & Family=="Hydropsychidae")
hydro_eff_coch<-prune_taxa(taxa_sums(hydro_eff_coch) > 0, hydro_eff_coch) 
hydro_eff_coch #105 taxa, 8 samples = 100% prevalence

sample_sums(hydro_eff_coch) #100% prevalence
...
hydro_eff_sun<-subset_samples(effluent_bac, Site=="Sunalta" & Family=="Hydropsychidae")
hydro_eff_sun<-prune_taxa(taxa_sums(hydro_eff_sun) > 0, hydro_eff_sun) 
hydro_eff_sun #92 taxa, 7 samples = 100% prevalence

sample_sums(hydro_eff_sun) #100% prevalence
...
hydro_eff_cush<-subset_samples(effluent_bac, Site=="Cushing Bridge" & Family=="Hydropsychidae")
hydro_eff_cush<-prune_taxa(taxa_sums(hydro_eff_cush) > 0, hydro_eff_cush) 
hydro_eff_cush #101 taxa, 5 samples = 100% prevalence

sample_sums(hydro_eff_cush) #100% prevalence
...
# Graves Bridge #
nsamples(hydro_grvbr<-subset_samples(sample_ps, Site=="Graves Bridge" & Family=="Hydropsychidae")) #8

hydro_eff_grvbr<-subset_samples(effluent_bac, Site=="Graves Bridge" & Family=="Hydropsychidae")
hydro_eff_grvbr<-prune_taxa(taxa_sums(hydro_eff_grvbr) > 0, hydro_eff_grvbr) 
hydro_eff_grvbr #194 taxa, 8 samples = 100% prevalence

sample_sums(hydro_eff_grvbr) #100% prevalence
...
hydro_eff_pmf<-subset_samples(effluent_bac, Site=="Policeman Flats" & Family=="Hydropsychidae")
hydro_eff_pmf<-prune_taxa(taxa_sums(hydro_eff_pmf) > 0, hydro_eff_pmf) 
hydro_eff_pmf #186 taxa, 8 samples = 100% prevalence

sample_sums(hydro_eff_pmf) #100% prevalence
...
hydro_eff_ACWA<-subset_samples(effluent_bac, Stream_Type!="Bow River" & Family=="Hydropsychidae")
hydro_eff_ACWA<-prune_taxa(taxa_sums(hydro_eff_ACWA) > 0, hydro_eff_ACWA) 
hydro_eff_ACWA #296 taxa, 24 samples

# REF #

hydro_eff_REF<-subset_samples(hydro_eff_ACWA, Site=="BRR2")
hydro_eff_REF<-prune_taxa(taxa_sums(hydro_eff_REF) > 0, hydro_eff_REF) 
hydro_eff_REF #181 taxa, 8 samples

sample_sums(hydro_eff_REF) #100% prevalence
...
hydro_eff_EFF5<-prune_taxa(taxa_sums(hydro_eff_EFF5) > 0, hydro_eff_EFF5) 
hydro_eff_EFF5 #230 taxa, 8 samples

sample_sums(hydro_eff_EFF5) #100% prevalence
...
hydro_eff_EFF15<-prune_taxa(taxa_sums(hydro_eff_EFF15) > 0, hydro_eff_EFF15) 
hydro_eff_EFF15 #172 taxa, 8 samples

sample_sums(hydro_eff_EFF15) #100% prevalence
...
hep_eff_coch<-subset_samples(effluent_bac, Site=="Cochrane" & Family=="Heptageniidae")
hep_eff_coch<-prune_taxa(taxa_sums(hep_eff_coch) > 0, hep_eff_coch) 
hep_eff_coch #247 taxa, 8 samples = 100% prevalence
...
hep_eff_sun<-subset_samples(effluent_bac, Site=="Sunalta" & Family=="Heptageniidae")
hep_eff_sun<-prune_taxa(taxa_sums(hep_eff_sun) > 0, hep_eff_sun) 
hep_eff_sun #273 taxa, 8 samples = 100% prevalence
...
hep_eff_cush<-subset_samples(effluent_bac, Site=="Cushing Bridge" & Family=="Heptageniidae")
hep_eff_cush<-prune_taxa(taxa_sums(hep_eff_cush) > 0, hep_eff_cush) 
hep_eff_cush #227 taxa, 8 samples = 100% prevalence

sample_sums(hep_eff_cush) #100% prevalence
...
nsamples(hep_grvbr<-subset_samples(sample_ps, Site=="Graves Bridge" & Family=="Heptageniidae")) #8

hep_eff_grvbr<-subset_samples(effluent_bac, Site=="Graves Bridge" & Family=="Heptageniidae")
hep_eff_grvbr<-prune_taxa(taxa_sums(hep_eff_grvbr) > 0, hep_eff_grvbr) 
hep_eff_grvbr #246 taxa, 8 samples = 100% prevalence

sample_sums(hep_eff_grvbr) #100% prevalence
...
hep_eff_pmf<-subset_samples(effluent_bac, Site=="Policeman Flats" & Family=="Heptageniidae")
hep_eff_pmf<-prune_taxa(taxa_sums(hep_eff_pmf) > 0, hep_eff_pmf) 
hep_eff_pmf #336 taxa, 8 samples = 100% prevalence

sample_sums(hep_eff_pmf) #100% prevalence
...
baetid_eff_EFF5<-prune_taxa(taxa_sums(baetid_eff_EFF5) > 0, baetid_eff_EFF5) 
baetid_eff_EFF5 #215 taxa, 8 samples

sample_sums(baetid_eff_EFF5) #100% prevalence
...
baetid_eff_EFF15<-prune_taxa(taxa_sums(baetid_eff_EFF15) > 0, baetid_eff_EFF15) 
baetid_eff_EFF15 #203 taxa, 7 samples

sample_sums(baetid_eff_EFF15) #100% prevalence
...
nsamples(perl_coch<-subset_samples(sample_ps, Site=="Cochrane" & Family=="Chironomidae")) #4

chiro_eff_coch<-subset_samples(effluent_bac, Site=="Cochrane" & Family=="Chironomidae")
chiro_eff_coch<-prune_taxa(taxa_sums(chiro_eff_coch) > 0, chiro_eff_coch) 
chiro_eff_coch #64 taxa, 4 samples = 100% prevalence

sample_sums(chiro_eff_coch) #100% prevalence
...
nsamples(chiro_cush<-subset_samples(sample_ps, Site=="Cushing Bridge" & Family=="Chironomidae")) #4

chiro_eff_cush<-subset_samples(effluent_bac, Site=="Cushing Bridge" & Family=="Chironomidae")
chiro_eff_cush<-prune_taxa(taxa_sums(chiro_eff_cush) > 0, chiro_eff_cush) 
chiro_eff_cush #102 taxa, 4 samples = 100% prevalence

sample_sums(chiro_eff_cush) #100% prevalence
...
chiro_eff_pmf<-subset_samples(effluent_bac, Site=="Policeman Flats" & Family=="Chironomidae")
chiro_eff_pmf<-prune_taxa(taxa_sums(chiro_eff_pmf) > 0, chiro_eff_pmf) 
chiro_eff_pmf #145 taxa, 5 samples = 100% prevalence
...
nsamples(perl_coch<-subset_samples(sample_ps, Site=="Cochrane" & Family=="Perlidae")) #8

perl_eff_coch<-subset_samples(effluent_bac, Site=="Cochrane" & Family=="Perlidae")
perl_eff_coch<-prune_taxa(taxa_sums(perl_eff_coch) > 0, perl_eff_coch) 
perl_eff_coch #116 taxa, 8 samples = 100% prevalence

sample_sums(perl_eff_coch) #100% prevalence
...
perl_eff_cush<-subset_samples(effluent_bac, Site=="Cushing Bridge" & Family=="Perlidae")
perl_eff_cush<-prune_taxa(taxa_sums(perl_eff_cush) > 0, perl_eff_cush) 
perl_eff_cush #228 taxa, 5 samples = 100% prevalence

sample_sums(perl_eff_cush) #100% prevalence
...
perl_eff_pmf<-subset_samples(effluent_bac, Site=="Policeman Flats" & Family=="Perlidae")
perl_eff_pmf<-prune_taxa(taxa_sums(perl_eff_pmf) > 0, perl_eff_pmf) 
perl_eff_pmf #162 taxa, 8 samples = 100% prevalence
...
trichop_eff_coch<-subset_samples(effluent_bac, Site=="Cochrane" & Family=="Trichoptera")
trichop_eff_coch<-prune_taxa(taxa_sums(trichop_eff_coch) > 0, trichop_eff_coch) 
trichop_eff_coch #159 taxa, 7 samples = 87.5% prevalence
...
trichop_eff_sun<-subset_samples(effluent_bac, Site=="Sunalta" & Family=="Trichoptera")
trichop_eff_sun<-prune_taxa(taxa_sums(trichop_eff_sun) > 0, trichop_eff_sun) 
trichop_eff_sun #112 taxa, 7 samples = 87.5% prevalence
...
trichop_eff_cush<-subset_samples(effluent_bac, Site=="Cushing Bridge" & Family=="Trichoptera")
trichop_eff_cush<-prune_taxa(taxa_sums(trichop_eff_cush) > 0, trichop_eff_cush) 
trichop_eff_cush #178 taxa, 7 samples = 87.5% prevalence
...
nsamples(trichop_grvbr<-subset_samples(sample_ps, Site=="Graves Bridge" & Family=="Trichoptera")) #7

trichop_eff_grvbr<-subset_samples(effluent_bac, Site=="Graves Bridge" & Family=="Trichoptera")
trichop_eff_grvbr<-prune_taxa(taxa_sums(trichop_eff_grvbr) > 0, trichop_eff_grvbr) 
trichop_eff_grvbr #166 taxa, 7 samples = 100% prevalence

sample_sums(trichop_eff_grvbr) #100% prevalence
...
ephem_eff_coch<-subset_samples(effluent_bac, Site=="Cochrane" & Family=="Ephemeroptera")
ephem_eff_coch<-prune_taxa(taxa_sums(ephem_eff_coch) > 0, ephem_eff_coch) 
ephem_eff_coch #89 taxa, 8 samples = 100% prevalence

sample_sums(ephem_eff_coch) #100% prevalence
...
ephem_eff_sun<-subset_samples(effluent_bac, Site=="Sunalta" & Family=="Ephemeroptera")
ephem_eff_sun<-prune_taxa(taxa_sums(ephem_eff_sun) > 0, ephem_eff_sun) 
ephem_eff_sun #112 taxa, 8 samples = 100% prevalence
...
ephem_eff_cush<-subset_samples(effluent_bac, Site=="Cushing Bridge" & Family=="Ephemeroptera")
ephem_eff_cush<-prune_taxa(taxa_sums(ephem_eff_cush) > 0, ephem_eff_cush) 
ephem_eff_cush #75 taxa, 5 samples = 62.5% prevalence
...
nsamples(ephem_grvbr<-subset_samples(sample_ps, Site=="Graves Bridge" & Family=="Ephemeroptera")) #8

ephem_eff_grvbr<-subset_samples(effluent_bac, Site=="Graves Bridge" & Family=="Ephemeroptera")
ephem_eff_grvbr<-prune_taxa(taxa_sums(ephem_eff_grvbr) > 0, ephem_eff_grvbr) 
ephem_eff_grvbr #86 taxa, 8 samples = 100% prevalence

sample_sums(ephem_eff_grvbr) #100% prevalence
...
ephem_eff_pmf<-subset_samples(effluent_bac, Site=="Policeman Flats" & Family=="Ephemeroptera")
ephem_eff_pmf<-prune_taxa(taxa_sums(ephem_eff_pmf) > 0, ephem_eff_pmf) 
ephem_eff_pmf #121 taxa, 7 samples = 87.5% prevalence
...
ephem_eff_EFF5<-prune_taxa(taxa_sums(ephem_eff_EFF5) > 0, ephem_eff_EFF5) 
ephem_eff_EFF5 #34 taxa, 8 samples

sample_sums(ephem_eff_EFF5) #100% prevalence
...
ephem_eff_EFF15<-prune_taxa(taxa_sums(ephem_eff_EFF15) > 0, ephem_eff_EFF15) 
ephem_eff_EFF15 #73 taxa, 8 samples

sample_sums(ephem_eff_EFF15) #100% prevalence
...
nsamples(dip_coch<-subset_samples(sample_ps, Site=="Cochrane" & Family=="Diptera")) #5

dip_eff_coch<-subset_samples(effluent_bac, Site=="Cochrane" & Family=="Diptera")
dip_eff_coch<-prune_taxa(taxa_sums(dip_eff_coch) > 0, dip_eff_coch) 
dip_eff_coch #74 taxa, 5 samples = 100% prevalence

sample_sums(dip_eff_coch) #100% prevalence
...
dip_eff_cush<-subset_samples(effluent_bac, Site=="Cushing Bridge" & Family=="Diptera")
dip_eff_cush<-prune_taxa(taxa_sums(dip_eff_cush) > 0, dip_eff_cush) 
dip_eff_cush #98 taxa, 8 samples = 100% prevalence

sample_sums(dip_eff_cush) #100% prevalence
...
nsamples(dip_pmf<-subset_samples(sample_ps, Site=="Policeman Flats" & Family=="Diptera")) #6

dip_eff_pmf<-subset_samples(effluent_bac, Site=="Policeman Flats" & Family=="Diptera")
dip_eff_pmf<-prune_taxa(taxa_sums(dip_eff_pmf) > 0, dip_eff_pmf) 
dip_eff_pmf #84 taxa, 6 samples = 100% prevalence
...
aran_eff_coch<-subset_samples(effluent_bac, Site=="Cochrane" & Family=="Araneidae")
aran_eff_coch<-prune_taxa(taxa_sums(aran_eff_coch) > 0, aran_eff_coch) 
aran_eff_coch #82 taxa, 8 samples = 100% prevalence

sample_sums(aran_eff_coch) #100% prevalence
...
nsamples(aran_sun<-subset_samples(sample_ps, Site=="Sunalta" & Family=="Araneidae")) #7

aran_eff_sun<-subset_samples(effluent_bac, Site=="Sunalta" & Family=="Araneidae")
aran_eff_sun<-prune_taxa(taxa_sums(aran_eff_sun) > 0, aran_eff_sun) 
aran_eff_sun #114 taxa, 7 samples = 100% prevalence
...
aran_eff_cush<-subset_samples(effluent_bac, Site=="Cushing Bridge" & Family=="Araneidae")
aran_eff_cush<-prune_taxa(taxa_sums(aran_eff_cush) > 0, aran_eff_cush) 
aran_eff_cush #89 taxa, 7 samples = 100% prevalence
...
nsamples(aran_grvbr<-subset_samples(sample_ps, Site=="Graves Bridge" & Family=="Araneidae")) #8

aran_eff_grvbr<-subset_samples(effluent_bac, Site=="Graves Bridge" & Family=="Araneidae")
aran_eff_grvbr<-prune_taxa(taxa_sums(aran_eff_grvbr) > 0, aran_eff_grvbr) 
aran_eff_grvbr #103 taxa, 8 samples = 100% prevalence
...
nsamples(aran_pmf<-subset_samples(sample_ps, Site=="Policeman Flats" & Family=="Araneidae")) #6

aran_eff_pmf<-subset_samples(effluent_bac, Site=="Policeman Flats" & Family=="Araneidae")
aran_eff_pmf<-prune_taxa(taxa_sums(aran_eff_pmf) > 0, aran_eff_pmf) 
aran_eff_pmf #126 taxa, 6 samples = 100% prevalence
...
tetra_eff_coch<-subset_samples(effluent_bac, Site=="Cochrane" & Family=="Tetragnathidae")
tetra_eff_coch<-prune_taxa(taxa_sums(tetra_eff_coch) > 0, tetra_eff_coch) 
tetra_eff_coch #58 taxa, 6 samples = 75% prevalence

sample_sums(tetra_eff_coch) #100% prevalence
...
tetra_eff_sun<-subset_samples(effluent_bac, Site=="Sunalta" & Family=="Tetragnathidae")
tetra_eff_sun<-prune_taxa(taxa_sums(tetra_eff_sun) > 0, tetra_eff_sun) 
tetra_eff_sun #9 taxa, 5 samples = 62.5% prevalence
...
tetra_eff_cush<-subset_samples(effluent_bac, Site=="Cushing Bridge" & Family=="Tetragnathidae")
tetra_eff_cush<-prune_taxa(taxa_sums(tetra_eff_cush) > 0, tetra_eff_cush) 
tetra_eff_cush #92 taxa, 8 samples = 100% prevalence
...
nsamples(tetra_grvbr<-subset_samples(sample_ps, Site=="Graves Bridge" & Family=="Tetragnathidae")) #8

tetra_eff_grvbr<-subset_samples(effluent_bac, Site=="Graves Bridge" & Family=="Tetragnathidae")
tetra_eff_grvbr<-prune_taxa(taxa_sums(tetra_eff_grvbr) > 0, tetra_eff_grvbr) 
tetra_eff_grvbr #31 taxa, 5 samples = 62.5% prevalence
...
tetra_eff_pmf<-subset_samples(effluent_bac, Site=="Policeman Flats" & Family=="Tetragnathidae")
tetra_eff_pmf<-prune_taxa(taxa_sums(tetra_eff_pmf) > 0, tetra_eff_pmf) 
tetra_eff_pmf #104 taxa, 8 samples = 100% prevalence
