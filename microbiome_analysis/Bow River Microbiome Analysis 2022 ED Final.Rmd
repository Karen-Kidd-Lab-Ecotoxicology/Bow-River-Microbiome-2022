...
nsamples(blank_Bow) #17
exp_bl_ps_Bow<-merge_phyloseq(blank_Bow, Bow_ps)
nsamples(exp_bl_ps_Bow) #293 (276 samples, 17 blanks)
...
ord_NMDS_blanks_Bow #stress=0.196
...
#ggsave(filename="microbiome_analysis/Final analysis/Beta Diversity Graphs/blank and experimental samples Bow River.png", height=10, width=12)
...
adonis.blanks.Bow #p<0.001. Significant dissimilarity between blank samples and invertebrate samples
#F(1, 291) = 3.48, P < 0.001
...
anova(bd_blanks_Bow) #Sig. dispersion F(1,291) = 54.5, p<0.001
...
picrust_diff_abund_hydro_Bow_plot<-ggplot(picrust_sigtab_exposed_hydro_Bow, aes(x=log2FoldChange, y=description))+
  geom_point(size=8) + 
  theme_bw()+
  theme(axis.text.y = element_text(size=16, face="italic", color="black")) + theme(axis.text.x=element_text(size=16, color="black"), axis.title=element_text(size=36)) +
          theme(legend.text=element_text(size=34, color="black")) + 
          theme(legend.title = element_text(size=34, color="black"), legend.position="bottom")+
  guides(color=guide_legend(nrow=3, byrow=TRUE))+
  rremove("grid")+
...
# Hydropsychidae #
picrust_diff_abund_hydro_Bow_plot_1<- picrust_diff_abund_hydro_Bow_plot + rremove("axis.title") + rremove("legend")
picrust_diff_abund_hydro_Bow_plot_1

# Heptageniidae #
picrust_diff_abund_hep_plot_1<- picrust_diff_abund_hep_Bow_plot + rremove("axis.title")+ rremove("legend")
picrust_diff_abund_hep_plot_1

# Chironomidae #
picrust_diff_abund_chiro_plot_1<- picrust_diff_abund_chiro_Bow_plot + rremove("axis.title")+ rremove("legend")
picrust_diff_abund_chiro_plot_1

# Trichoptera #
picrust_diff_abund_trichop_plot_1<- picrust_diff_abund_trichop_Bow_plot + rremove("axis.title")+ rremove("legend")
...
ggarrange(picrust_diff_abund_hydro_Bow_plot_1,  picrust_diff_abund_hep_plot_1, picrust_diff_abund_chiro_plot_1, picrust_diff_abund_trichop_plot_1, picrust_diff_abund_ephem_plot_1, nrow=2, ncol=3, common.legend = T, legend="bottom")

#ggsave(filename="microbiome_analysis/PICRUSt2 Data/Figures/picrust DA across taxa Bow River faceted.png", height=28, width=30, bg="white")
