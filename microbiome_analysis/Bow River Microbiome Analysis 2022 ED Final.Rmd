...
top_coch_phy_hep<- hep_coch_phy %>%
  mutate(Phylum = fct_other(Phylum, keep=c("Cyanobacteria", "Proteobacteria", "Firmicutes")))
#Use these standard deviations for the phyla that were kept (the top phyla)
...
top_cush_phy_chiro$SD_squared_divided =(top_cush_phy_chiro$SD_squared/6) 
...
top_pmf_phy_chiro$SD_squared_divided =(top_pmf_phy_chiro$SD_squared/4) 
...
top_coch_phy_ephem<- ephem_coch_phy %>%
  mutate(Phylum = fct_other(Phylum, keep=c("Cyanobacteria", "Firmicutes", "Proteobacteria")))
...
top_EFF5_phy_baetid<- baetid_EFF5_phy %>%
  mutate(Phylum = fct_other(Phylum, keep=c("Bacteroidota", "Cyanobacteria", "Proteobacteria")))
...
top_EFF15_phy_baetid$SD_squared_divided =(top_EFF15_phy_baetid$SD_squared/8) 
...
top_coch_phy_dip<- dip_coch_phy %>%
  mutate(Phylum = fct_other(Phylum, keep=c("Firmicutes", "Cyanobacteria", "Proteobacteria")))
...
top_pmf_phy_dip$SD_squared_divided =(top_pmf_phy_dip$SD_squared/8) 
...
top_sun_phy_aran$SD_squared_divided =(top_sun_phy_aran$SD_squared/8) 
...
kruskal.test(data=hydro_phylum_Bow, rel_abund ~ Site) #p = 0.98
dunnTest(data=hydro_phylum_Bow, rel_abund ~ Site) #no sig. diff

#Proteobacteria
proteo_hydro_Bow<-subset(hydro_phylum_Bow, taxon=="Proteobacteria")
kruskal.test(data=proteo_hydro_Bow, rel_abund ~ Site) #p = 0.802 no diff.

#Bacteroidota
bacter_hydro_Bow<-subset(hydro_phylum_Bow, taxon=="Bacteroidota")
kruskal.test(data=bacter_hydro_Bow, rel_abund ~ Site) #p = 0.43 no diff.
...
kruskal.test(data=cyano_hep_Bow, rel_abund ~ Site) #p < 0.001, chi-squared: 23.3 
...
kruskal.test(data=cyano_chiro_Bow, rel_abund ~ Site) #p = 0.1184
...
kruskal.test(data=cyano_perl_Bow, rel_abund ~ Site) #p = 0.0029, chi-sq: 11.7 
...
kruskal.test(data=proteo_ephem_Bow, rel_abund ~ Site) #p = 0.023, chi-sq: 11.3
dunnTest(data=proteo_ephem_Bow, rel_abund ~ Site) 
#CUSHBR - GRVBR p = 0.011

#Bacteroidota
bacter_ephem_Bow<-subset(ephem_phylum_Bow, taxon=="Bacteroidota")
kruskal.test(data=bacter_ephem_Bow, rel_abund ~ Site) #p = 0.0065, chi-sq: 14.3
...
kruskal.test(data=cyano_ephem_Bow, rel_abund ~ Site) #p = 0.0029, chi-sq: 16.1
...
kruskal.test(data=bacter_aran_Bow, rel_abund ~ Site) #p < 0.001, chi-sq: 20.7
...
kruskal.test(data=cyano_aran_Bow, rel_abund ~ Site) #p < 0.001, chi-sq: 23.0
...
kruskal.test(data=proteo_hydro_ACWA, rel_abund ~ Site) #p = 0.1054 no diff.
dunnTest(data=proteo_hydro_ACWA, rel_abund ~ Site) #no diff

#Bacteroidota
bacter_hydro_ACWA<-subset(hydro_ACWA_phylum, taxon=="Bacteroidota")
kruskal.test(data=bacter_hydro_ACWA, rel_abund ~ Site) #p = 0.123, chi-sq: 4.19 no diff.

#Firmicutes
firm_hydro_Bow<-subset(hydro_ACWA_phylum, taxon=="Firmicutes")
kruskal.test(data=firm_hydro_Bow, rel_abund ~ Site) #p = 0.0701, chi-sq: 5.32
...
dunnTest(data=cyano_hydro_Bow, rel_abund ~ Site) 
#EFF5 has higher Cyanobacteria proportion compared to REF Z = 2.55, P = 0.0327
...
baetid_ACWA_phylum$taxon<-factor(baetid_ACWA_phylum$taxon, levels=c("Other", "Firmicutes","Cyanobacteria", "Bacteroidota", "Proteobacteria"))
...
kruskal.test(data=proteo_baetid_ACWA, rel_abund ~ Site) #p = 0.247

#Bacteroidota
bacter_baetid_ACWA<-subset(baetid_ACWA_phylum, taxon=="Bacteroidota")
kruskal.test(data=bacter_baetid_ACWA, rel_abund ~ Site) #p = 0.418
...
ephem_ACWA_phylum$taxon<-factor(ephem_ACWA_phylum$taxon, levels=c("Other", "Cyanobacteria", "Firmicutes", "Proteobacteria", "Bacteroidota"))
...
kruskal.test(data=proteo_ephem_ACWA, rel_abund ~ Site) #p = 0.142

#Bacteroidota
bacter_ephem_ACWA<-subset(ephem_ACWA_phylum, taxon=="Bacteroidota")
kruskal.test(data=bacter_ephem_ACWA, rel_abund ~ Site) #p = 0.345

#Firmicutes
firm_ephem_Bow<-subset(ephem_ACWA_phylum, taxon=="Firmicutes")
kruskal.test(data=firm_ephem_Bow, rel_abund ~ Site) #p = 0.00865, chi-sq: 6.89
...
#ggsave(filename="microbiome_analysis/Final analysis/Relative abundance/All samples/point range rel abund graph ACWA across taxa.png", height=6, width=10, bg="white")
```
...
#ggsave(filename="microbiome_analysis/Final Analysis/Relative abundance/All samples/Mean relative abundance of top 5 phyla across invertebrate taxa Bow only.png", height=10, width=22)

#### Class Level ####
rel_abun_class <- tax_glom(sample_ps, taxrank = "Class")
...
sample.df.agg.class$Site <- factor(sample.df.agg.class$Site, levels=c("Cochrane", "Sunalta", "Cushing Bridge", "Graves Bridge", "Policeman Flats"))
...
top_class <- sample.df.agg.class %>%
    ...
    arrange(-Mean)
top_class
top10class <- top_class$Class[1:80]
...
top10classplot <- ggplot(top10classdf, aes(x=Site_code, y=Abundance, fill=Class)) + 
  ...
  theme(axis.title.y=element_text(size=22),
        ...
        axis.text.x=element_text(angle=45, hjust=1, size=16, color="black", face=colorado(df0_bow$Site_code, c("GRVBR", "PMF"))),
                        axis.title.x=element_text(size=22))+
  scale_fill_manual(name="Bacterial Phylum", values=c("#66C2A5", "#FC8D62", "#8DA0CB", "#E78AC3", "#43464B", "#FFD92F"))+
  scale_y_continuous(label = scales::percent)+
  rremove("grid")
top10classplot

#ggsave(filename="microbiome_analysis/Final Analysis/Relative abundance/All samples/Mean relative abundance of top 5 classes across invertebrates Bow only.png", height=10, width=22)
...
top_fam_Bow <- sample.df.agg_fam_Bow %>%
    ...
    summarize(Mean = mean(Abundance)) %>%
    arrange(-Mean)
top25fam_Bow <- top_fam_Bow$Family[1:87]
...
#ggsave(filename="microbiome_analysis/Final analysis/Relative abundance/All samples/Top 25 families across inverts and sites Bow only.png", height=10, width=22)
...
top_genus_Bow <- sample.df.agg_genus_Bow %>%
    ...
    summarize(Mean = mean(Abundance)) %>%
    arrange(-Mean)
top30genus_Bow <- top_genus_Bow$Genus[1:78]
...
top30genusplotBow <- ggplot(top30genusdf_Bow, aes(x=factor(Site_code, labels = c("COCH", "SUN", "CUSHBR", "GRVBR", "PMF")), y=Abundance, fill=Genus)) +
  ...
  scale_fill_manual(name="Genus", values=c("#fcff5d", "#7dfc00", "#0ec434", "#228c68", "#8ad8e8", "#235b54", "#29bdab", "#3998f5", "#37294f", "#277da7", "#3750db", "#f22020", "#991919", "#ffcba5", "#e68f66", "#c56133", "#96341c", "#632819", "#ffc413", "#f47a22", "#2f2aa0", "#b732cc", "#772b9d", "#f07cab", "#d30b94", "#edeff3", "#c3a5b4", "#946aa2", "#5d4c86","#43464B"))+
  scale_y_continuous(label = scales::percent)+
  xlab("Site")+
  rremove("grid")
...
#ggsave(filename="microbiome_analysis/Final analysis/Relative abundance/All samples/Top 30 genera across inverts and sites Bow only.png", height=10, width=26)
...
glom_ad_Bow <- tax_glom(ad_Bow, taxrank = "Genus")
rel_abun_ad_Bow <- transform_sample_counts(glom_ad_Bow, function(x) x/sum(x))

rel_abun_ad_Bow_df <- psmelt(rel_abun_ad_Bow)

agg_ad_Bow<- aggregate(Abundance ~ Genus + Site_code + sample_Family + Stage, data = rel_abun_ad_Bow_df, FUN = mean) 


#Top 10 genus, all inverts included
top_genus_ad_Bow <- agg_ad_Bow %>%
    group_by(Site_code, Genus) %>%
    summarize(Mean = mean(Abundance)) %>%
    arrange(-Mean)
top10genus_ad_Bow <- top_genus_ad_Bow$Genus[1:20]
top10genusaddfBow <- agg_ad_Bow %>%
    mutate(Genus = fct_other(Genus, top10genus_ad_Bow))

top10genusaddf_Bow <- aggregate(Abundance ~ Genus + Site_code + sample_Family + Stage, data = top10genusaddfBow, FUN = sum)

#Top 10 across all adults:         
...
top10genusaddf_Bow$sample_Family<-factor(top10genusaddf_Bow$sample_Family, levels=c("Trichoptera", "Ephemeroptera", "Diptera"))


top10genusadplotBow <- ggplot(top10genusaddf_Bow, aes(x=factor(Site_code, labels = c("COCH", "SUN", "CUSHBR", "GRVBR", "PMF")), y=Abundance, fill=Genus)) +
  geom_bar(stat="identity", color="black") + 
  ylab("Mean Relative Abundance") +
  facet_nested_wrap(~Stage+sample_Family, scale="free_x", nrow=1) + 
  theme_bw()+
...
#ggsave(filename="microbiome_analysis/Final analysis/Relative abundance/All samples/Top 10 genera adults.png", height=10, width=14)
...
glom_spi_Bow <- tax_glom(spi_Bow, taxrank = "Genus")
rel_abun_spi_Bow <- transform_sample_counts(glom_spi_Bow, function(x) x/sum(x))

rel_abun_spi_Bow_df <- psmelt(rel_abun_spi_Bow)

agg_spi_Bow<- aggregate(Abundance ~ Genus + Site_code + sample_Family + Stage, data = rel_abun_spi_Bow_df, FUN = mean) 


#Top 10 genus, all inverts included
top_genus_spi_Bow <- agg_spi_Bow %>%
    group_by(Site_code, Genus) %>%
    summarize(Mean = mean(Abundance)) %>%
    arrange(-Mean)
top10genus_spi_Bow <- top_genus_spi_Bow$Genus[1:28]
top10genusspidfBow <- agg_spi_Bow %>%
    mutate(Genus = fct_other(Genus, top10genus_spi_Bow))

top10genusspidf_Bow <- aggregate(Abundance ~ Genus + Site_code + sample_Family + Stage, data = top10genusspidfBow, FUN = sum)

#Top 7 across all spiders:         
...
top10genusspidf_Bow$sample_Family<-factor(top10genusspidf_Bow$sample_Family, levels=c("Araneidae", "Tetragnathidae"))


top10genusspiplotBow <- ggplot(top10genusspidf_Bow, aes(x=factor(Site_code, labels = c("COCH", "SUN", "CUSHBR", "GRVBR", "PMF")), y=Abundance, fill=Genus)) +
  geom_bar(stat="identity", color="black") + 
  ylab("Mean Relative Abundance") +
  facet_nested_wrap(~Stage+sample_Family, scale="free_x", nrow=1) + 
  theme_bw()+
  ...
  xlab("Site")+
  rremove("grid")
top10genusspiplotBow 

#ggsave(filename="microbiome_analysis/Final analysis/Relative abundance/All samples/Top 10 genera spiders.png", height=10, width=14)


ggarrange(top10genuslarplotBow, top10genusadplotBow, top10genusspiplotBow, nrow=3)

#ggsave(filename="microbiome_analysis/Final analysis/Relative abundance/All samples/Top 10 genera across life stage combined.png", height=16, width=20)
```
...
cyano_fam_Bow <- tax_glom(cyano_Bow, taxrank = "Family")
cyano_fam_Bow #10 families
...
cyano_fam_Bow_agg <- aggregate(Abundance ~ Family + Site_code + sample_Family + Stage, data = cyano_fam_Bow_df, FUN = mean) 
...
cyano_fam_Bow_agg$sample_Family<-factor(cyano_fam_Bow_agg$sample_Family, levels=c("Hydropsychidae", "Heptageniidae", "Chironomidae", "Perlidae", "Trichoptera", "Ephemeroptera", "Diptera", "Araneidae", "Tetragnathidae"), labels=c("Hydropsychidae", "Heptageniidae", "Chironomidae", "Perlidae", "Trichoptera", "Ephemeroptera", "Chironomidae ", "Araneidae", "Tetragnathidae"))
...
#ggsave(filename="microbiome_analysis/Final analysis/Relative abundance/Cyanobacteria/Cyanobacteria families across taxa and sites.png", height=12, width=26)
...
kruskal.test(Shannon~Stage, data=adiv_Bow) #p<0.001, chi-sq: 136.2
...
leveneTest(Shannon~Site, data=adiv_hydro_Bow) #Homogeneity. p = 0.264.
#Use ANOVA
summary(hydro_aov<-aov(Shannon~Site, data=adiv_hydro_Bow)) #p<0.001, F(4,31) = 22.0
TukeyHSD(hydro_aov)
#GRVBR - COCH
#PMF - COCH
#GRVBR - SUN
...
#Use Kruskal-Wallis
kruskal.test(Shannon~Site, data=div.df.Bow.Tricho) #p= 0.669
...
shapiro.test(div.df.Bow.Hep$Shannon) #Normal dist. p = 0.663
leveneTest(Shannon~Site, data=div.df.Bow.Hep) #Homogeneity
#Use ANOVA
summary(hep_aov<-aov(Shannon~Site, data=div.df.Bow.Hep)) #p=0.0623
TukeyHSD(hep_aov)
#COCH - PMF

#Adult Ephemeroptera
div.df.Bow.Ephem<-subset(adiv_Bow, Family=="Ephemeroptera")
shapiro.test(div.df.Bow.Ephem$Shannon) #p=0.008, not normal
leveneTest(Shannon~Site, data=div.df.Bow.Ephem) #Homogeneity p = 0.115
#Use Kruskal-Wallis
kruskal.test(Shannon~Site, data=div.df.Bow.Ephem) #p=0.187
...
#Use AnOVA
summary(chiro_aov<-aov(Shannon~Site, data=div.df.Bow.chiro)) #p=0.128
TukeyHSD(chiro_aov)
...
#Use ANOVA
summary(dip_aov<-aov(Shannon~Site, data=div.df.Bow.dip)) #p=0.944
TukeyHSD(dip_aov)
#No differences across sites

#Larval Perlidae
div.df.Bow.perl<-subset(adiv_Bow, Family=="Perlidae")
shapiro.test(div.df.Bow.perl$Shannon) #0.017 not normal
leveneTest(Shannon~Site, data=div.df.Bow.perl) #0.02231. Homogeneity
#Use Kruskal-Wallis
kruskal.test(Shannon~Site, data=div.df.Bow.perl) #p=0.4296
dunnTest(Shannon~Site, data=div.df.Bow.perl) #No sig diff across sites

summary(perl_aov<-aov(Shannon~Site, data=div.df.Bow.perl)) #p=0.314
TukeyHSD(perl_aov) #ANOVA also indicates no differences. 

#Araneidae
div.df.Bow.aran<-subset(adiv_Bow, Family=="Araneidae")
shapiro.test(div.df.Bow.aran$Shannon) #0.0945. Normal
leveneTest(Shannon~Site, data=div.df.Bow.aran) #0.77 homogeneity
#Use ANOVA
summary(aran_aov<-aov(Shannon~Site, data=div.df.Bow.aran)) #p=0.162
TukeyHSD(aran_aov)
#No differences across sites
...
#Use KW
kruskal.test(Shannon~Site, data=div.df.Bow.tetra) #p=0.29
...
#Diff btw families
kruskal.test(Shannon~Family, data=adiv_ACWA)#p<0.001, chi-sq: 37.0
...
#Use ANOVA
summary(hydro_ACWA_aov<-aov(data=hydro_ACWA, Shannon~Site)) #P = 0.278, ANOVA F(2,21)=1.36
...
shapiro.test(baetid_ACWA$Shannon) # normal p =0.096
leveneTest(data=baetid_ACWA, Shannon~Site) #0.602. homogeneity
#Use t test
t.test(data=baetid_ACWA, Shannon~Site) #p=0.795, t = -0.265, df=12.1
#No difference between streams
...
### Calculating median +/- IQR Shannon Index Bow and ACWA
...
nsamples(exp_bl_ps) #358 (335 samples, 23 blanks)
...
ord_NMDS_blanks #stress=0.206


blank_nmds<-plot_ordination(ps_rel_abun, ord_NMDS_blanks) + 
  geom_point(aes(colour=factor(Sample_Type), shape=factor(Blank_Type)), size=2)+
  theme_classic() +
  theme(strip.background = element_blank())+
  theme(legend.key.size = unit(1, 'cm'), 
  ...
  scale_colour_manual(name="Sample type", values=c("red", "blue"))
...
anova(bd_blanks) #Sig. dispersion F(1,356) = 58.0, p<0.001
...
#Total variation explained: 0.301%
#Site explains 8.50% of the total variance explained whereas Family explained 91.5% of the total variation explained
...
#ggsave(filename="microbiome_analysis/Final analysis/Beta Diversity Graphs/NMDS all data Bow only relative abundance.png", height=10, width=14)
...
#ggsave(filename="microbiome_analysis/Final Analysis/Beta Diversity Graphs/All samples combined/NMDS across Bow River invertebrates and sites faceted.png", height=10, width=20)
...
#ggsave(filename="microbiome_analysis/Final analysis/Beta Diversity Graphs/NMDS across sites faceted by invertebrate taxa Bow only.png", height=10, width=16)
...
ord_NMDS_Bow_no_spi #Stress=0.174
...
#ggsave(filename="microbiome_analysis/Final analysis/Beta Diversity Graphs/NMDS across sites faceted by invertebrate taxa Bow only no spiders.png", height=10, width=16)
...
anova(bd_all_site_Bow) #no beta disper p = 0.313
...
test.adonis.Bow.hydro #p<0.001, F(4,31)=4.30, R^2=0.357. 
...
anova(bd_all_fam_Bow_hydro) #no beta dispersion p = 0.079
...
anova(bd_all_fam_Bow_hep) #sig beta dispersion p = 0.0085
...
anova(bd_all_fam_Bow_chiro) #no beta dispersion p = 0.673
...
anova(bd_all_fam_Bow_perl) #yes, sig beta dispersion p = 0.0161
...
test.adonis.Bow.trichop #p = 0.037 

#Pairwise comparisons
pairwise.adonis2(Bow_bray_trichop ~ Site, data = metadata_Bow_trichop)
#Only COCH - GRVBR and CUSHBR - GRVBR were sig. different from each other (not all upstream sites were different from GRVBR)

bd_all_fam_Bow_trichop<-betadisper(Bow_bray_trichop, metadata_Bow_trichop$Site) 
anova(bd_all_fam_Bow_trichop) #no beta dispersion p = 0.896
...
anova(bd_all_fam_Bow_ephem) #yes beta dispersion p = 0.00394
...
anova(bd_all_fam_Bow_dip) #no beta dispersion p = 0.967
...
anova(bd_all_fam_Bow_aran) #no beta dispersion p = 0.973
...
anova(bd_all_fam_Bow_tetra) #no beta dispersion p = 0.515
...
anova(bd_all_fam_Bow_coch) #yes beta dispersion p = 0.0047.
...
test.adonis.Bow.sun #p < 0.001, F(5,41) = 4.54
...
anova(bd_all_fam_Bow_sun) #yes beta dispersion p = 0.00498.
...
test.adonis.Bow.cush #p < 0.001, F(8.54) = 5.96
...
anova(bd_all_fam_Bow_cush) #yes beta dispersion p = 0.000469.
...
anova(bd_all_fam_Bow_grv) #yes beta dispersion p = 0.0112.
...
#We're using Spearman correlations because we have non-parametric data (abundance data is usually highly skewed)
abund_env #r = 0.00805, p = 0.290. Environment not selecting for the microbiome composition. Not sig. 
...
abund_temp # Mantel r=0.0127, p=0.186
...
abund_DO # Mantel r=0.00905, p=0.248
...
abund_cond # Mantel r=0.0224, p=0.017

#Conductivity significantly selects for the microbiome community
...
abund_TP # Mantel r=0.0150, p=0.218
...
abund_TDS # Mantel r=0.0224, p=0.02

#Total dissolved solids is a significant predictor of microbiome composition
...
abund_TSS # Mantel r=0.01127, p=0.248
...
abund_TOC # Mantel r=0.0494, p=0.007

#Total organic carbon is a significant predictor of microbiome composition
...
abund_pH # Mantel r=0.0040, p=0.426
...
abund_NO3 # Mantel r=0.01127, p=0.259

#Total organic carbon, total dissolved solids, and conductivity were significant predictors of microbiome composition in the Bow River
...
#Site explains 4.39% of the total variance explained whereas Family explained 42.7% of the total variation explained
...
#ggsave(filename="microbiome_analysis/Final analysis/Beta Diversity Graphs/All samples combined/NMDS faceted by inverts ACWA only.png", height=8, width=10)
...
abund_temp_ACWA # Mantel r=0.0472, p=0.065
...
abund_DO_ACWA # Mantel r=0.0472, p=0.063
...
abund_cond_ACWA # Mantel r=0.0723, p=0.036
...
abund_NH3_ACWA # Mantel r=0.0472, p=0.065
...
abund_pH_ACWA # Mantel r=0.0201, p=0.159
...
abund_DN_ACWA # Mantel r=0.0472, p=0.075
...
abund_NO3_ACWA # Mantel r=0.0472, p=0.049

#Significant predictor of microbiome composition
...
abund_NO2_ACWA # Mantel r=0.04719, p=0.064
...
abund_DOC_ACWA # Mantel r=0.0257, p=0.129
...
abund_PO4_ACWA # Mantel r=0.0472, p=0.063
