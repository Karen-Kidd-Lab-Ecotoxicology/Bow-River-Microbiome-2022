...
eff_hep_coch #276 taxa, 8/8 samples = 100% prevalence
...
#Rhodoferax (18.8%), Pseudorhodobacter (6.88%), Ferruginibacter (6.16%)
...
effluent_sun #521 taxa, 44 samples/47 = 93.6 %

sort((table(tax_table(effluent_sun)[,6]))/sum(ntaxa(effluent_sun))*100)
#Rhodoferax (12.7%), Massilia (6.33%), Pseudorhodobacter (6.14%)
...
sort((table(tax_table(effluent_Bow)[,6]))/sum(ntaxa(effluent_Bow))*100) #116 genera
#Rhodoferax (10.4%), Pseudorhodobacter (6.39%), Hyphomicrobium (4.33%)
sum(sample_sums(effluent_Bow))/sum(sample_sums(Bow_ps))*100
#Effluent bacteria comprises 9.16% of the total microbiome in the Bow River (across all invertebrate types). Decently small amount.
...
effluents_Bow <- sort_genus_Bow$Genus[c(31:35, 46:50, 51:56, 81:85, 101:105, 111:115, 146:150, 156:160, 166:170, 191:195, 201:205, 241:245, 251:255, 256:260, 276:280, 281:285, 286:290, 301:305, 361:365, 396:400, 401:405, 426:430, 436:440, 506:510, 521:525, 536:540, 541:545, 551:556, 561:565, 566:580, 606:610, 626:630, 631:635, 646:650, 666:670, 676:680, 691:695, 701:705, 706:710, 711:715, 716:720, 721:725, 781:785, 806:810, 816:820, 831:835, 841:845, 866:870, 941:945, 1021:1025, 1026:1030, 1031:1035, 1041:1045, 1051:1055, 1081:1085, 1101:1110, 1156:1160, 1206:1210, 1241:1245, 1266:1270, 1271:1275, 1321:1325, 1336:1340, 1346:1350, 1361:1365, 1366:1370, 1386:1395, 1411:1415, 1466:1485, 1496:1510, 1521:1525, 1541:1545, 1566:1570, 1596:1605, 1641:1645, 1656:1665, 1691:1695, 1706:1715, 1746:1750, 1771:1775, 1791:1795, 1801:1805, 1811:1815, 1826:1830, 1861:1870, 1876:1880, 1921:1925, 1936:1940, 1951:1955, 1966:1975, 2001:2005, 2016:2025, 2046:2050, 2096:2100, 2106:2110, 2141:2145, 2161:2165, 2231:2235, 2366:2370, 2381:2385)]
...
top_eff_bow <- eff_agg_df_Bow %>%
    group_by(Genus) %>%
    summarise(Mean = mean(Abundance)) %>%
    arrange(-Mean)
View(top_eff_bow)
top_eff_bow_30 <- top_eff_bow$Genus[1:31]
eff_bow <- eff_agg_df_Bow %>%
    mutate(Genus = fct_other(Genus, top_eff_bow_30))
df0_bow
df0_bow<-aggregate(Abundance~Phylum + Site_code + sample_Family+Stage, data=df0_bow, FUN="sum")
...
eff_plot_Bow <- ggplot(eff_agg_df_Bow, aes(x=Site_code, y=Abundance, fill=Genus)) +
  ...
  theme(strip.text = element_text(size = 22, color="black")) + 
  theme(legend.key.size = unit(0.8, "cm"),
        legend.text=element_text(size=12, face="italic"), legend.title=element_text(size=12), legend.position = "right") +
  guides(fill=guide_legend(nrow=40, ncol=3)) +
  theme(axis.title.y=element_text(size=30),
        axis.text.y=element_text(size=24, color="black"),
        axis.text.x=element_text(angle=45, hjust=1, size=24, color="black"),
                        axis.title.x=element_text(size=30))+
...
#ggsave(eff_plot_Bow, filename="microbiome_analysis/Final analysis/Relative abundance/Effluent bacteria/Effluent associated bacteria Bow river.png", height=14, width=28)

#Too many colours... try top 30 most abundant...
```
