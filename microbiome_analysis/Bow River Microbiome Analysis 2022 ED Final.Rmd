...
```{r}
#### Bacteroidota to Proteobacteria ####
...
picrust_diff_abund_hydro_ACWA_plot<-ggplot(picrust_sigtab_REF_EFF5_hydro_ACWA, aes(x=log2FoldChange, y=description))+
  geom_point(size=8) + 
  theme_bw()+
  theme(axis.text.y = element_text(size=40, face="italic", color="black")) + theme(axis.text.x=element_text(size=34, color="black"), axis.title=element_text(size=36)) +
          theme(legend.text=element_text(size=34, color="black")) + 
...
picrust_diff_abund_hydro_ACWA_plot

#ggsave(filename="microbiome_analysis/PICRUSt2 Data/Figures/REF-EFF5 hydro diff abun pathways ACWA.png", height=24, width=22)
...
picrust_diff_abund_hydro_ACWA_plot<-ggplot(picrust_sigtab_REF_EFF15_hydro_ACWA, aes(x=log2FoldChange, y=description))+
  geom_point(size=8) + 
  theme_bw()+
  theme(axis.text.y = element_text(size=40, face="italic", color="black")) + theme(axis.text.x=element_text(size=34, color="black"), axis.title=element_text(size=36)) +
          theme(legend.text=element_text(size=34, color="black")) + 
...
#ggsave(filename="microbiome_analysis/PICRUSt2 Data/Figures/REF-EFF15 hydro diff abun pathways ACWA.png", height=24, width=22)
...
picrust_deseq_EFF5_EFF15_ephem_ACWA
...
#ggsave(filename="microbiome_analysis/PICRUSt2 Data/Figures/EFF5-EFF15 ephem diff abun pathways ACWA.png", height=24, width=22)
