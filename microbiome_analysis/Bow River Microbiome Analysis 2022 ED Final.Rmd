...
picrust_grvbr_coch_hep = tapply(picrust_sigtab_grvbr_coch_hep$log2FoldChange, picrust_sigtab_grvbr_coch_hep$Phylum, function(x) max(x))
picrust_grvbr_coch_hep = sort(picrust_grvbr_coch_hep, TRUE)
picrust_sigtab_grvbr_coch_hep$Phylum = factor(as.character(picrust_sigtab_grvbr_coch_hep$Phylum), levels=names(picrust_grvbr_coch_hep))
#79 diff abun pathways
