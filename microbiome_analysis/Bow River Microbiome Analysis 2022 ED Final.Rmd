...
#Exposed vs non wastewater exposed sites (all sites included)
...
#ggsave(filename="microbiome_analysis/Final analysis/Differential Abundance Results/Exposed vs Unexposed sites hydropsychidae larvae Bow.png", height=24, width=24)

#No color legend

ggplot(sigtab_exposed_hydro_Bow, aes(x=log2FoldChange, y=Genus))+
  geom_point(size=8) + 
  theme_bw()+
  theme(axis.text.y = element_text(size=40, face="italic", color="black")) + theme(axis.text.x=element_text(size=34, color="black"), axis.title=element_text(size=36)) +
          theme(legend.text=element_text(size=34, color="black")) + 
...
#ggsave(filename="microbiome_analysis/Final analysis/Differential Abundance Results/Exposed vs Unexposed sites hydropsychidae larvae Bow no legend.png", height=24, width=24)


#Exposed vs non wastewater exposed sites (Cushing Bridge compared to both downstream sites)
hydro_ps_Bow<-subset_samples(sample_ps, Family=="Hydropsychidae" & Stream_Type=="Bow River")

hydro_ps_Bow_subset<-subset_samples(hydro_ps_Bow, Site!="Cochrane" & Site!="Sunalta")

deseq_exposed_hydro_Bow_subset <- phyloseq_to_deseq2(hydro_ps_Bow_subset, ~ Exposure)
#Re level the reference variable so that the comparison is exposed vs unexposed
deseq_exposed_hydro_Bow_subset$Exposure <-relevel(deseq_exposed_hydro_Bow_subset$Exposure, "Unexposed")

deseq_exposed_hydro_Bow_subset <- DESeq(deseq_exposed_hydro_Bow_subset, test = "Wald", fitType = "parametric", sfType = "poscounts")

res_deseq_exposed_hydro_Bow_subset <- results(deseq_exposed_hydro_Bow_subset, cooksCutoff = FALSE)
alpha = 0.001
sigtab_exposed_hydro_Bow_subset = res_deseq_exposed_hydro_Bow_subset[which(res_deseq_exposed_hydro_Bow_subset$padj < alpha), ]
sigtab_exposed_hydro_Bow_subset = cbind(as(sigtab_exposed_hydro_Bow_subset, "data.frame"), as(tax_table(hydro_ps_Bow_subset)[rownames(sigtab_exposed_hydro_Bow_subset), ], "matrix"))

x_exposed_hydro_Bow_subset = tapply(sigtab_exposed_hydro_Bow_subset$log2FoldChange, sigtab_exposed_hydro_Bow_subset$Phylum, function(x) max(x))
x_exposed_hydro_Bow_subset = sort(x_exposed_hydro_Bow_subset, TRUE)
sigtab_exposed_hydro_Bow_subset$Phylum = factor(as.character(sigtab_exposed_hydro_Bow_subset$Phylum), levels=names(x_exposed_hydro_Bow_subset))
# Genus
x_exposed_hydro_Bow_subset = tapply(sigtab_exposed_hydro_Bow_subset$log2FoldChange, sigtab_exposed_hydro_Bow_subset$Genus, function(x) max(x))
x_exposed_hydro_Bow_subset = sort(x_exposed_hydro_Bow_subset, TRUE)
sigtab_exposed_hydro_Bow_subset$Genus = factor(as.character(sigtab_exposed_hydro_Bow_subset$Genus), levels=sort(names(x_exposed_hydro_Bow_subset)))
#44 differentially abundant taxa

sigtab_exposed_hydro_Bow_subset$Genus <- factor(sigtab_exposed_hydro_Bow_subset$Genus, levels=c("Anaerocella", "Clostridium sensu stricto 1", "Defluviimonas", "Ellin6067", "Hydrogenophaga", "Hypnocyclicus", "M2PB4-61 termite group", "Mucinivorans", "Pseudorhodobacter", "Rhizorhapis", "Rhodobacter", "Runella", "Sphingorhabdus", "Sulfurospirillum", "Tyzzerlla", "NA"), labels=c("Anaerocella", "Clostridium sensu stricto 1", "Defluviimonas", "Ellin6067", "Hydrogenophaga", "Hypnocyclicus", "M2PB4-61 termite group", "Mucinivorans", "Pseudorhodobacter", "Rhizorhapis", "Rhodobacter", "Runella", "Sphingorhabdus", "Sulfurospirillum", "Tyzzerlla", "Unidentified"))

sigtab_exposed_hydro_Bow_subset$Genus[is.na(sigtab_exposed_hydro_Bow_subset$Genus)] <- "Unidentified"

diff_abund_hydro_Bow_plot_subset<-ggplot(sigtab_exposed_hydro_Bow_subset, aes(x=log2FoldChange, y=Genus, color=Phylum))+
...
diff_abund_hydro_Bow_plot_subset
...
hydro_cush_coch<-subset_samples(hydro_ps_Bow, Site=="Cushing Bridge" | Site=="Cochrane")
...
hydro_cushbr_coch<-subset_samples(hydro_ps_Bow, Site=="Cochrane" | Site=="Cushing Bridge")

deseq_cushbr_coch_hydro <- phyloseq_to_deseq2(hydro_cushbr_coch, ~ Site)

deseq_cushbr_coch_hydro <- DESeq(deseq_cushbr_coch_hydro, test = "Wald", fitType = "parametric", sfType = "poscounts")

res_deseq_cushbr_coch_hydro <- results(deseq_cushbr_coch_hydro, cooksCutoff = FALSE)
res_deseq_cushbr_coch_hydro
alpha = 0.001
sigtab_cushbr_coch_hydro = res_deseq_cushbr_coch_hydro[which(res_deseq_cushbr_coch_hydro$padj < alpha), ]
sigtab_cushbr_coch_hydro = cbind(as(sigtab_cushbr_coch_hydro, "data.frame"), as(tax_table(hydro_cushbr_coch)[rownames(sigtab_cushbr_coch_hydro), ], "matrix"))

x_cushbr_coch_hydro = tapply(sigtab_cushbr_coch_hydro$log2FoldChange, sigtab_cushbr_coch_hydro$Phylum, function(x) max(x))
x_cushbr_coch_hydro = sort(x_cushbr_coch_hydro, TRUE)
sigtab_cushbr_coch_hydro$Phylum = factor(as.character(sigtab_cushbr_coch_hydro$Phylum), levels=names(x_cushbr_coch_hydro))
# Genus
x_cushbr_coch_hydro = tapply(sigtab_cushbr_coch_hydro$log2FoldChange, sigtab_cushbr_coch_hydro$Genus, function(x) max(x))
x_cushbr_coch_hydro = sort(x_cushbr_coch_hydro, TRUE)
sigtab_cushbr_coch_hydro$Genus = factor(as.character(sigtab_cushbr_coch_hydro$Genus), levels=sort(names(x_cushbr_coch_hydro)))
#12 observations

diff_abund_hydro_cushbr_coch_plot<-ggplot(sigtab_cushbr_coch_hydro, aes(x=log2FoldChange, y=Genus, color=Phylum))+
  geom_point(aes(fill=Phylum), pch=21, size=6, color="black") +
  theme_bw()+
  theme(axis.text.y = element_text(size=24, face="italic", color="black")) + theme(axis.text.x=element_text(size=24, color="black"), axis.title=element_text(size=28)) +
          theme(legend.text=element_text(size=24, color="black")) + 
...
diff_abund_hydro_cushbr_coch_plot
...
hydro_cushbr_sun<-subset_samples(hydro_ps_Bow, Site=="Sunalta" | Site=="Cushing Bridge")

deseq_cushbr_sun_hydro <- phyloseq_to_deseq2(hydro_cushbr_sun, ~ Site)

deseq_cushbr_sun_hydro <- DESeq(deseq_cushbr_sun_hydro, test = "Wald", fitType = "parametric", sfType = "poscounts")

res_deseq_cushbr_sun_hydro <- results(deseq_cushbr_sun_hydro, cooksCutoff = FALSE)
res_deseq_cushbr_sun_hydro
alpha = 0.001
sigtab_cushbr_sun_hydro = res_deseq_cushbr_sun_hydro[which(res_deseq_cushbr_sun_hydro$padj < alpha), ]
sigtab_cushbr_sun_hydro = cbind(as(sigtab_cushbr_sun_hydro, "data.frame"), as(tax_table(hydro_cushbr_sun)[rownames(sigtab_cushbr_sun_hydro), ], "matrix"))

x_cushbr_sun_hydro = tapply(sigtab_cushbr_sun_hydro$log2FoldChange, sigtab_cushbr_sun_hydro$Phylum, function(x) max(x))
x_cushbr_sun_hydro = sort(x_cushbr_sun_hydro, TRUE)
sigtab_cushbr_sun_hydro$Phylum = factor(as.character(sigtab_cushbr_sun_hydro$Phylum), levels=names(x_cushbr_sun_hydro))
# Genus
x_cushbr_sun_hydro = tapply(sigtab_cushbr_sun_hydro$log2FoldChange, sigtab_cushbr_sun_hydro$Genus, function(x) max(x))
x_cushbr_sun_hydro = sort(x_cushbr_sun_hydro, TRUE)
sigtab_cushbr_sun_hydro$Genus = factor(as.character(sigtab_cushbr_sun_hydro$Genus), levels=sort(names(x_cushbr_sun_hydro)))
#15 observations

diff_abund_hydro_cushbr_sun_plot<-ggplot(sigtab_cushbr_sun_hydro, aes(x=log2FoldChange, y=Genus, color=Phylum))+
  geom_point(aes(fill=Phylum), pch=21, size=6, color="black") + 
  theme_bw()+
  theme(axis.text.y = element_text(size=24, face="italic", color="black")) + theme(axis.text.x=element_text(size=24, color="black"), axis.title=element_text(size=28)) +
          theme(legend.text=element_text(size=24, color="black")) + 
...
diff_abund_hydro_cushbr_sun_plot

#ggsave(filename="microbiome_analysis/Final analysis/Differential Abundance Results/Cushing Bridge vs Sunalta hydropsychidae larvae.png", height=20, width=22)


#CUSHBR - GRVBR

hydro_cushbr_grvbr<-subset_samples(hydro_ps_Bow, Site=="Graves Bridge" | Site=="Cushing Bridge")

deseq_cushbr_grvbr_hydro <- phyloseq_to_deseq2(hydro_cushbr_grvbr, ~ Site)

deseq_cushbr_grvbr_hydro$Site <-relevel(deseq_cushbr_grvbr_hydro$Site, "Graves Bridge") #Releveling to make Cushing Bridge be compared to Graves Bridge

deseq_cushbr_grvbr_hydro <- DESeq(deseq_cushbr_grvbr_hydro, test = "Wald", fitType = "parametric", sfType = "poscounts")

res_deseq_cushbr_grvbr_hydro <- results(deseq_cushbr_grvbr_hydro, cooksCutoff = FALSE)
res_deseq_cushbr_grvbr_hydro
alpha = 0.001
sigtab_cushbr_grvbr_hydro = res_deseq_cushbr_grvbr_hydro[which(res_deseq_cushbr_grvbr_hydro$padj < alpha), ]
sigtab_cushbr_grvbr_hydro = cbind(as(sigtab_cushbr_grvbr_hydro, "data.frame"), as(tax_table(hydro_cushbr_grvbr)[rownames(sigtab_cushbr_grvbr_hydro), ], "matrix"))

x_cushbr_grvbr_hydro = tapply(sigtab_cushbr_grvbr_hydro$log2FoldChange, sigtab_cushbr_grvbr_hydro$Phylum, function(x) max(x))
x_cushbr_grvbr_hydro = sort(x_cushbr_grvbr_hydro, TRUE)
sigtab_cushbr_grvbr_hydro$Phylum = factor(as.character(sigtab_cushbr_grvbr_hydro$Phylum), levels=names(x_cushbr_grvbr_hydro))
# Genus
x_cushbr_grvbr_hydro = tapply(sigtab_cushbr_grvbr_hydro$log2FoldChange, sigtab_cushbr_grvbr_hydro$Genus, function(x) max(x))
x_cushbr_grvbr_hydro = sort(x_cushbr_grvbr_hydro, TRUE)
sigtab_cushbr_grvbr_hydro$Genus = factor(as.character(sigtab_cushbr_grvbr_hydro$Genus), levels=sort(names(x_cushbr_grvbr_hydro)))
#13 observations

diff_abund_hydro_cushbr_grvbr_plot<-ggplot(sigtab_cushbr_grvbr_hydro, aes(x=log2FoldChange, y=Genus, color=Phylum))+
  geom_point(aes(fill=Phylum), pch=21, size=6, color="black") +
  theme_bw()+
  theme(axis.text.y = element_text(size=24, face="italic", color="black")) + theme(axis.text.x=element_text(size=24, color="black"), axis.title=element_text(size=28)) +
          theme(legend.text=element_text(size=24, color="black")) + 
...
diff_abund_hydro_cushbr_grvbr_plot

#ggsave(filename="microbiome_analysis/Final analysis/Differential Abundance Results/Cushing Bridge vs Graves Bridge hydropsychidae larvae.png", height=20, width=22)


#CUSHBR - PMF

hydro_cushbr_pmf<-subset_samples(hydro_ps_Bow, Site=="Policeman Flats" | Site=="Cushing Bridge")

deseq_cushbr_pmf_hydro <- phyloseq_to_deseq2(hydro_cushbr_pmf, ~ Site)

deseq_cushbr_pmf_hydro$Site <-relevel(deseq_cushbr_pmf_hydro$Site, "Policeman Flats") #Releveling to make Cushing Bridge be compared to Graves Bridge

deseq_cushbr_pmf_hydro <- DESeq(deseq_cushbr_pmf_hydro, test = "Wald", fitType = "parametric", sfType = "poscounts")

res_deseq_cushbr_pmf_hydro <- results(deseq_cushbr_pmf_hydro, cooksCutoff = FALSE)
res_deseq_cushbr_pmf_hydro
alpha = 0.001
sigtab_cushbr_pmf_hydro = res_deseq_cushbr_pmf_hydro[which(res_deseq_cushbr_pmf_hydro$padj < alpha), ]
sigtab_cushbr_pmf_hydro = cbind(as(sigtab_cushbr_pmf_hydro, "data.frame"), as(tax_table(hydro_cushbr_pmf)[rownames(sigtab_cushbr_pmf_hydro), ], "matrix"))

x_cushbr_pmf_hydro = tapply(sigtab_cushbr_pmf_hydro$log2FoldChange, sigtab_cushbr_pmf_hydro$Phylum, function(x) max(x))
x_cushbr_pmf_hydro = sort(x_cushbr_pmf_hydro, TRUE)
sigtab_cushbr_pmf_hydro$Phylum = factor(as.character(sigtab_cushbr_pmf_hydro$Phylum), levels=names(x_cushbr_pmf_hydro))
# Genus
x_cushbr_pmf_hydro = tapply(sigtab_cushbr_pmf_hydro$log2FoldChange, sigtab_cushbr_pmf_hydro$Genus, function(x) max(x))
x_cushbr_pmf_hydro = sort(x_cushbr_pmf_hydro, TRUE)
sigtab_cushbr_pmf_hydro$Genus = factor(as.character(sigtab_cushbr_pmf_hydro$Genus), levels=sort(names(x_cushbr_pmf_hydro)))
#97 observations

diff_abund_hydro_cushbr_pmf_plot<-ggplot(sigtab_cushbr_pmf_hydro, aes(x=log2FoldChange, y=Genus, color=Phylum))+
  geom_point(aes(fill=Phylum), pch=21, size=6, color="black") +
  theme_bw()+
  theme(axis.text.y = element_text(size=24, face="italic", color="black")) + theme(axis.text.x=element_text(size=24, color="black"), axis.title=element_text(size=28)) +
          theme(legend.text=element_text(size=24, color="black")) + 
...
diff_abund_hydro_cushbr_pmf_plot

#ggsave(filename="microbiome_analysis/Final analysis/Differential Abundance Results/Cushing Bridge vs Policeman Flats hydropsychidae larvae.png", height=20, width=22)
...
## Separating out the super pathways from the pathway type 
```{r}
...
fun_sep_summary <- fun_sep %>%
  ...
  summarize(sum_types = sum(Relative_Abundance))
...
#try boxplot?
#scale everything, then restrict to top 10 pathways
fun_sep_scale <- fun_sep_summary %>%
  group_by(pathway_type) %>%
  mutate(scaled.val = scale(sum_types)[,1]) %>% ## need to be scaled, since we are comparing enzymes to gene counts
  group_by()## make so all are "moved up" into positive by same amount

#all groups
fun_sep_scale %>%
  ggplot(aes(x = site, y = sum_types, fill = year)) +
  facet_wrap(~pathway_type) +
  geom_boxplot() +
  theme_bw(base_size = 14) + theme(legend.position="bottom")

#need to restrict the boxplot to only the top 10 groups or something. put the rest in other
#2714 = greater than 2%
#1711 = greater than 3%

#arrange in decreasing abundance
fun_sep_summary1 <- fun_sep_summary %>%
  arrange(-sum_types)

#restrict to things greater than 2%

#take the top 17 
top15 <- fun_sep_summary1$pathway_type[1:2714]

fun_sep_summary1$pathway_type<- as.factor(fun_sep_summary1$pathway_type)

top_fungroups <- fun_sep_summary1 %>%
  mutate(pathway_type = fct_other(pathway_type, top15)) %>%
  group_by(year, site, rep, pathway_type) 

#restrict only degradation or biosynthesis pathways for primary metabolites
top_fungroups1 <- top_fungroups %>%
  filter(pathway_type != "C1-COMPOUNDS") %>%
  filter(pathway_type != "Metabolic-Clusters") %>%
  filter(pathway_type != "SECONDARY-METABOLITE-DEGRADATION") %>%
  filter(pathway_type != "SECONDARY-METABOLITE-BIOSYNTHESIS") %>%
  filter(pathway_type != "Energy-Metabolism") %>%
  droplevels


#unique(top_fungroups$pathway_type)

top_fungroups1$pathway_type <- as.factor(top_fungroups1$pathway_type)
levels(top_fungroups1$pathway_type) <- c("Amino Acid Biosynthesis", "Cofactor Biosynthesis", "Nucleotide Biosynthesis", "Lipid Biosynthesis", "Carbohydrate Biosynthesis", "Cell-Structure Biosynthesis", "Tetrapyrrole Biosynthesis", "Carbohydrate Degradation", "Nucleotide Degradation", "Carboxylate Degredation", "Aromatic Degradation", "Noncarbon Nutrients", "Other")
...
#boxplot top 14
top_fungroups1 %>%
  filter(pathway_type != "Other") %>%
  ggplot(aes(x = site, y = sum_types, fill = year)) +
  facet_wrap(~pathway_type, ncol =2, scales = "free") +  scale_fill_brewer(palette = "Dark2") + 
  geom_boxplot() +
  ylab("Relative Abundance") + xlab("Site") +
  theme_bw(base_size = 14) + theme(legend.position="bottom") + scale_y_continuous(breaks = equal_breaks(n=3))

#how many aromatic compound degredation pathtways in the dataset?
pathways_aromdeg <- pathways_ontology %>%
  filter(pathway_type %in% c("AROMATIC-COMPOUNDS-DEGRADATION // CHLORINATED-COMPOUNDS-DEG", "AROMATIC-COMPOUNDS-DEGRADATION // SECONDARY-METABOLITE-DEGRADATION", "AROMATIC-COMPOUNDS-DEGRADATION"))

unique(pathways_aromdeg$pathway) #22 aromatic compound degradation pathways in the dataset
#20 only do aromatic deg, while 1 does aromatic deg and chlorinated deg and one does secondary metabolite deg and aromatic deg

#and what about the super pathways?
pathways_aromdeg_super <- pathways_ontology %>%
  filter(pathway_type %in% c("Super-Pathways // AROMATIC-COMPOUNDS-DEGRADATION // AMINE-DEG", "Super-Pathways // AROMATIC-COMPOUNDS-DEGRADATION"))

unique(pathways_aromdeg_super$pathway) #20 aromatic compound degradation super pathways in the dataset (1 that is both aromatic and amine deg) 
...
View(hydro_Bow_descrip_picrust)
...
#Amino acid biosynthesis, energy metabolism, super-pathways//nucleotide biosynthesis
