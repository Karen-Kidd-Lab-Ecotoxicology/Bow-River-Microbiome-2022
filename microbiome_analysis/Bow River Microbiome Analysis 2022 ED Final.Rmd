...
top_class <- sample.df.agg.class %>%
    ...
    arrange(-Mean)
top_class
top10class <- top_class$Class[1:46]
...
#ggsave(filename="microbiome_analysis/Final Analysis/Relative abundance/All samples/Mean rel abun top X classes Bow.png", height=10, width=22)
...
top_genus_Bow <- sample.df.agg_genus_Bow %>%
    ...
    summarize(Mean = mean(Abundance)) %>%
    arrange(-Mean)
top30genus_Bow <- top_genus_Bow$Genus[1:83]
...
#ggsave(filename="microbiome_analysis/Final analysis/Relative abundance/All samples/Mean rel abun top 30 genera Bow.png", height=10, width=26)
