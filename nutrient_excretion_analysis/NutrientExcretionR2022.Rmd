...
Nut_data$Site <- factor(Nut_data$Site, levels = c("Cochrane", "Sunalta", "Graves Bridge", "Policeman Flats", "BBR2", "PCR1", "PCR3"), labels=c("Cochrane", "Sunalta", "Graves Bridge", "Policeman Flats", "REF", "EFF5", "EFF15"))
...
# Combining P and N boxplots (Supplementary Info)
```{r 2 panel plot with N and P}
## All sites together (Bow and ACWA)
#PO4-P excretion rate normalized by mass of organism 

excr_P_plot_all<-ggplot(Nut_samples, aes(x=factor(Site, labels=c("COCH", "SUN", "GRVBR", "PMF", "REF", "EFF5", "EFF15")), y=Excr_rate_P))+ 
  geom_boxplot()+
  theme_classic()+
...
excr_NH3_plot_all<-ggplot(Nut_samples, aes(x=factor(Site, labels=c("COCH", "SUN", "GRVBR", "PMF", "REF", "EFF5", "EFF15")), y=Excr_rate_NH3))+ 
  geom_boxplot()+
  scale_y_log10()+
  theme_classic()+
