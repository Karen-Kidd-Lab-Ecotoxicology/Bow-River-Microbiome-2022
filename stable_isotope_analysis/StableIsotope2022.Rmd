...
isotope_subset$Stage<-factor(isotope_subset$Stage, levels=c("Terrestrial leaves", "Biofilm", "Aquatic larvae", "Aquatic adult","Terrestrial adult","Spider"))

isotope_subset$Site_Code<-factor(isotope_subset$Site_Code, levels=c("COCH", "SUN", "CUSHBR", "GRVBR", "PMF"))

isotope_subset$FFG<-factor(isotope_subset$FFG, levels=c("Basal food source", "Scraper", "Gatherer-Collector", "Filterer-Collector", "Predator", "Piercer"))
...
#ggsave(filename="C:\\Users\\Emilie\\Documents\\GitHub\\Bow-River-Microbiome-2022\\stable_isotope_analysis\\Figures\\N plot across FFG and stage with food sources.png", height=10, width=28)
...
#Removed 27 total: COCH_Ad_Hydro_SI_1, COCH_Ad_Hydro_SI_2, COCH_Lar_Hydro_SI_1, COCH_Lar_Hydro_SI_2, CUSHBR_Ad_Mayfly_1_SI_1, CUSHBR_Ad_Rhya_SI_1, CUSHBR_Lar_Chiro_SI_1, CUSHBR_Lar_Mayfly_1_SI_1, CUSHBR_Lar_Mayfly_1_SI_2, GRVBR_Ad_Chiro_SI_1, GRVBR_Ad_Mayfly_1_SI_1, GRVBR_Coleop_SI_1, GRVBR_Coleop_SI_2, GRVBR_Coleop_SI_3, GRVBR_Lar_Hydro_SI_1, GRVBR_Lar_Hydro_SI_2, GRVBR_Lar_Hydro_SI_3, POLFLT_Ad_Mayfly_1_SI_1, POLFLT_Ad_Rhya_SI_1, POLFLT_Biofilm_SI_1, POLFLT_Coleop_SI_1, POLFLT_Lar_Hydro_SI_1, POLFLT_Lar_Hydro_SI_2, POLFLT_Lar_Hydro_SI_3, SUNAL_Ad_Mayfly_1_SI_1, SUNAL_Lar_Hydro_SI_1, SUNAL_Lar_Hydro_SI_2, 
...
leveneTest(data=isotope_subset_no_food_sources, d15N~Site*FFG*Stage) #0.076
...
kruskal.test(data=biofilm_subset, d15N~Site) #p=0.113
...
shapiro.test(isotope_aq_lar$d15N) #0.148 #normal distribution
leveneTest(data=isotope_aq_lar, d15N~Site*FFG) #0.039, non homogeneity of variance
hist(isotope_aq_lar$d15N) #looks potentially bimodel
plot(isotope_aq_lar$d15N) #data may not be evenly spread

summary(N_lar_FFG_1<-aov(data=isotope_aq_lar, d15N~FFG*Site, na.action = na.exclude)) #Some interactions btw FFG and Site
...
plot(N_lar_scraper) #Mostly adheres to assumptions
...
N_plot<-N_plot_taxa_subset + theme(axis.title.x = element_blank())
