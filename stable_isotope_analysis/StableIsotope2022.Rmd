...
leveneTest(data=isotope_aq_lar, d13C~Site*FFG) #0.459, homogeneity of variance
...
summary_food_sources<-food_sources%>% 
  ...
  dplyr::summarise(MedianC = median(d13C), sdC = sd(d13C), MedianN = median(d15N), sdN = sd(d15N), n = n())
