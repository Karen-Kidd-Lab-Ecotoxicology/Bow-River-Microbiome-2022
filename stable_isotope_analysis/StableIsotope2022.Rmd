...
isotope_subset_lar<-subset(isotope, Stage!="Adult" & Taxa!="Perlidae" & Taxa!="Coleoptera" & Taxa!="Chironomidae" & Taxa!="Leptoceridae")

shapiro.test(isotope_subset_lar$d15N)  #Normal, p = 0.06. 
leveneTest(data=isotope_subset_lar, d15N~Site*Taxa) #homogeneity p = 0.705
hist(isotope_subset_lar$d15N) #looks decently normal 
...
isotope_subset_ad<-subset(isotope, Stage=="Adult")
