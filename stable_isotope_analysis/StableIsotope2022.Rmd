...
summary(aq_lar_lm<-aov(d13C~Site, data=aq_lar)) #F(4,49) = 11.8, p < 0.001
plot(aq_lar_lm)
emmeans(aq_lar_lm, specs = pairwise ~ Site)
#COCH - SUN
#COCH - GRVBR
...
#ggsave(filename="stable_isotope_analysis/Figures/C and N across taxa groups and sites.png", height=10, width=18, bg="white")
```
